...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      14:	71878793          	addi	a5,a5,1816 # 7728 <malloc+0x2574>
      18:	638c                	ld	a1,0(a5)
      1a:	6790                	ld	a2,8(a5)
      1c:	6b94                	ld	a3,16(a5)
      1e:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      70:	24450513          	addi	a0,a0,580 # 52b0 <malloc+0xfc>
      74:	088050ef          	jal	50fc <printf>
      exit(1);
      78:	4505                	li	a0,1
      ...
      9a:	8082                	ret
{
      ...
      aa:	22a50513          	addi	a0,a0,554 # 52d0 <malloc+0x11c>
      ae:	04e050ef          	jal	50fc <printf>
      exit(1);
      b2:	4505                	li	a0,1
...
00000000000000b8 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ca:	22250513          	addi	a0,a0,546 # 52e8 <malloc+0x134>
  ...
  fd = open("doesnotexist", 0);
      ...
      e0:	22c50513          	addi	a0,a0,556 # 5308 <malloc+0x154>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      fc:	1f850513          	addi	a0,a0,504 # 52f0 <malloc+0x13c>
     100:	7fd040ef          	jal	50fc <printf>
    exit(1);
     104:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     110:	20c50513          	addi	a0,a0,524 # 5318 <malloc+0x164>
     114:	7e9040ef          	jal	50fc <printf>
    exit(1);
     118:	4505                	li	a0,1
...
000000000000011e <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     186:	1be50513          	addi	a0,a0,446 # 5340 <malloc+0x18c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1b0:	1b450513          	addi	a0,a0,436 # 5360 <malloc+0x1ac>
     1b4:	749040ef          	jal	50fc <printf>
    exit(1);
     1b8:	4505                	li	a0,1
...
0000000000000240 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     25e:	12e50513          	addi	a0,a0,302 # 5388 <malloc+0x1d4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     272:	11aa8a93          	addi	s5,s5,282 # 5388 <malloc+0x1d4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2e0:	0bc50513          	addi	a0,a0,188 # 5398 <malloc+0x1e4>
     2e4:	619040ef          	jal	50fc <printf>
      exit(1);
     2e8:	4505                	li	a0,1
     ...
     2fa:	0c250513          	addi	a0,a0,194 # 53b8 <malloc+0x204>
     2fe:	5ff040ef          	jal	50fc <printf>
        exit(1);
     302:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     320:	0b450513          	addi	a0,a0,180 # 53d0 <malloc+0x21c>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     334:	0a098993          	addi	s3,s3,160 # 53d0 <malloc+0x21c>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     370:	06450513          	addi	a0,a0,100 # 53d0 <malloc+0x21c>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     384:	fd858593          	addi	a1,a1,-40 # 5358 <malloc+0x1a4>
     388:	18b040ef          	jal	4d12 <write>
     38c:	4785                	li	a5,1
     38e:	02f50d63          	beq	a0,a5,3c8 <badwrite+0xc0>
    printf("write failed\n");
     392:	00005517          	auipc	a0,0x5
     396:	05e50513          	addi	a0,a0,94 # 53f0 <malloc+0x23c>
     39a:	563040ef          	jal	50fc <printf>
    exit(1);
     39e:	4505                	li	a0,1
     3a0:	153040ef          	jal	4cf2 <exit>
      printf("open junk failed\n");
     3a4:	00005517          	auipc	a0,0x5
     3a8:	03450513          	addi	a0,a0,52 # 53d8 <malloc+0x224>
     3ac:	551040ef          	jal	50fc <printf>
      exit(1);
     3b0:	4505                	li	a0,1
     3b2:	141040ef          	jal	4cf2 <exit>
    printf("open junk failed\n");
     3b6:	00005517          	auipc	a0,0x5
     3ba:	02250513          	addi	a0,a0,34 # 53d8 <malloc+0x224>
     3be:	53f040ef          	jal	50fc <printf>
    exit(1);
     3c2:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3d2:	00250513          	addi	a0,a0,2 # 53d0 <malloc+0x21c>
...
00000000000004ac <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     4ca:	26278793          	addi	a5,a5,610 # 7728 <malloc+0x2574>
     4ce:	638c                	ld	a1,0(a5)
     4d0:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4fc:	f08a8a93          	addi	s5,s5,-248 # 5400 <malloc+0x24c>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     58e:	e7e50513          	addi	a0,a0,-386 # 5408 <malloc+0x254>
     592:	36b040ef          	jal	50fc <printf>
      exit(1);
     596:	4505                	li	a0,1
     ...
     5a4:	e8050513          	addi	a0,a0,-384 # 5420 <malloc+0x26c>
     5a8:	355040ef          	jal	50fc <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	e9a50513          	addi	a0,a0,-358 # 5450 <malloc+0x29c>
     5be:	33f040ef          	jal	50fc <printf>
      exit(1);
     5c2:	4505                	li	a0,1
     5c4:	72e040ef          	jal	4cf2 <exit>
      printf("pipe() failed\n");
     5c8:	00005517          	auipc	a0,0x5
     5cc:	eb850513          	addi	a0,a0,-328 # 5480 <malloc+0x2cc>
     5d0:	32d040ef          	jal	50fc <printf>
      exit(1);
     5d4:	4505                	li	a0,1
     ...
     5e2:	eb250513          	addi	a0,a0,-334 # 5490 <malloc+0x2dc>
     5e6:	317040ef          	jal	50fc <printf>
      exit(1);
     5ea:	4505                	li	a0,1
...
00000000000005f0 <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     60e:	11e78793          	addi	a5,a5,286 # 7728 <malloc+0x2574>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     642:	e82b0b13          	addi	s6,s6,-382 # 54c0 <malloc+0x30c>
    ...
    n = write(fds[1], "x", 1);
     ...
     652:	d0ab8b93          	addi	s7,s7,-758 # 5358 <malloc+0x1a4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     6d8:	df450513          	addi	a0,a0,-524 # 54c8 <malloc+0x314>
     6dc:	221040ef          	jal	50fc <printf>
      exit(1);
     6e0:	4505                	li	a0,1
     ...
     6ee:	df650513          	addi	a0,a0,-522 # 54e0 <malloc+0x32c>
     6f2:	20b040ef          	jal	50fc <printf>
      exit(1);
     6f6:	4505                	li	a0,1
     6f8:	5fa040ef          	jal	4cf2 <exit>
      printf("pipe() failed\n");
     6fc:	00005517          	auipc	a0,0x5
     700:	d8450513          	addi	a0,a0,-636 # 5480 <malloc+0x2cc>
     704:	1f9040ef          	jal	50fc <printf>
      exit(1);
     708:	4505                	li	a0,1
     70a:	5e8040ef          	jal	4cf2 <exit>
      printf("pipe write failed\n");
     70e:	00005517          	auipc	a0,0x5
     712:	e0250513          	addi	a0,a0,-510 # 5510 <malloc+0x35c>
     716:	1e7040ef          	jal	50fc <printf>
      exit(1);
     71a:	4505                	li	a0,1
     ...
     728:	e0450513          	addi	a0,a0,-508 # 5528 <malloc+0x374>
     72c:	1d1040ef          	jal	50fc <printf>
      exit(1);
     730:	4505                	li	a0,1
...
0000000000000736 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     74e:	bf650513          	addi	a0,a0,-1034 # 5340 <malloc+0x18c>
     752:	5f0040ef          	jal	4d42 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     756:	60100593          	li	a1,1537
     75a:	00005517          	auipc	a0,0x5
     75e:	be650513          	addi	a0,a0,-1050 # 5340 <malloc+0x18c>
     762:	5d0040ef          	jal	4d32 <open>
     766:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     768:	4611                	li	a2,4
     76a:	00005597          	auipc	a1,0x5
     76e:	be658593          	addi	a1,a1,-1050 # 5350 <malloc+0x19c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     782:	bc250513          	addi	a0,a0,-1086 # 5340 <malloc+0x18c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     7a6:	b9e50513          	addi	a0,a0,-1122 # 5340 <malloc+0x18c>
     7aa:	588040ef          	jal	4d32 <open>
     7ae:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     7b0:	4581                	li	a1,0
     7b2:	00005517          	auipc	a0,0x5
     7b6:	b8e50513          	addi	a0,a0,-1138 # 5340 <malloc+0x18c>
  ...
  write(fd1, "abcdef", 6);
     ...
     7e8:	dd458593          	addi	a1,a1,-556 # 55b8 <malloc+0x404>
     7ec:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     81e:	b2650513          	addi	a0,a0,-1242 # 5340 <malloc+0x18c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     852:	d0a50513          	addi	a0,a0,-758 # 5558 <malloc+0x3a4>
     856:	0a7040ef          	jal	50fc <printf>
    exit(1);
     85a:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     866:	d1650513          	addi	a0,a0,-746 # 5578 <malloc+0x3c4>
     86a:	093040ef          	jal	50fc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     86e:	8652                	mv	a2,s4
     870:	85d6                	mv	a1,s5
     872:	00005517          	auipc	a0,0x5
     876:	d1650513          	addi	a0,a0,-746 # 5588 <malloc+0x3d4>
     87a:	083040ef          	jal	50fc <printf>
    exit(1);
     87e:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     88a:	d2250513          	addi	a0,a0,-734 # 55a8 <malloc+0x3f4>
     88e:	06f040ef          	jal	50fc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     892:	8652                	mv	a2,s4
     894:	85d6                	mv	a1,s5
     896:	00005517          	auipc	a0,0x5
     89a:	cf250513          	addi	a0,a0,-782 # 5588 <malloc+0x3d4>
     89e:	05f040ef          	jal	50fc <printf>
    exit(1);
     8a2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     8b0:	d1450513          	addi	a0,a0,-748 # 55c0 <malloc+0x40c>
     8b4:	049040ef          	jal	50fc <printf>
    exit(1);
     8b8:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     8c6:	d1e50513          	addi	a0,a0,-738 # 55e0 <malloc+0x42c>
     8ca:	033040ef          	jal	50fc <printf>
    exit(1);
     8ce:	4505                	li	a0,1
...
00000000000008d4 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     8f4:	d1050513          	addi	a0,a0,-752 # 5600 <malloc+0x44c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     90a:	d22a0a13          	addi	s4,s4,-734 # 5628 <malloc+0x474>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     90e:	00005b17          	auipc	s6,0x5
     912:	d52b0b13          	addi	s6,s6,-686 # 5660 <malloc+0x4ac>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     948:	cbc50513          	addi	a0,a0,-836 # 5600 <malloc+0x44c>
  ...
  if(unlink("small") < 0){
     ...
     978:	c8c50513          	addi	a0,a0,-884 # 5600 <malloc+0x44c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     9a0:	c6c50513          	addi	a0,a0,-916 # 5608 <malloc+0x454>
     9a4:	758040ef          	jal	50fc <printf>
    exit(1);
     9a8:	4505                	li	a0,1
     ...
     9b6:	c8650513          	addi	a0,a0,-890 # 5638 <malloc+0x484>
     9ba:	742040ef          	jal	50fc <printf>
      exit(1);
     9be:	4505                	li	a0,1
     ...
     9cc:	ca850513          	addi	a0,a0,-856 # 5670 <malloc+0x4bc>
     9d0:	72c040ef          	jal	50fc <printf>
      exit(1);
     9d4:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     9e0:	cbc50513          	addi	a0,a0,-836 # 5698 <malloc+0x4e4>
     9e4:	718040ef          	jal	50fc <printf>
    exit(1);
     9e8:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     9f4:	cc850513          	addi	a0,a0,-824 # 56b8 <malloc+0x504>
     9f8:	704040ef          	jal	50fc <printf>
    exit(1);
     9fc:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     a08:	ccc50513          	addi	a0,a0,-820 # 56d0 <malloc+0x51c>
     a0c:	6f0040ef          	jal	50fc <printf>
    exit(1);
     a10:	4505                	li	a0,1
...
0000000000000a16 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     a34:	cc050513          	addi	a0,a0,-832 # 56f0 <malloc+0x53c>
  ...
  fd = open("big", O_RDONLY);
     ...
     a78:	c7c50513          	addi	a0,a0,-900 # 56f0 <malloc+0x53c>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     ab6:	c4650513          	addi	a0,a0,-954 # 56f8 <malloc+0x544>
     aba:	642040ef          	jal	50fc <printf>
    exit(1);
     abe:	4505                	li	a0,1
     ...
     acc:	c5050513          	addi	a0,a0,-944 # 5718 <malloc+0x564>
     ad0:	62c040ef          	jal	50fc <printf>
      exit(1);
     ad4:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     ae0:	c6450513          	addi	a0,a0,-924 # 5740 <malloc+0x58c>
     ae4:	618040ef          	jal	50fc <printf>
    exit(1);
     ae8:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     b00:	bf450513          	addi	a0,a0,-1036 # 56f0 <malloc+0x53c>
     ...
     b28:	c3c50513          	addi	a0,a0,-964 # 5760 <malloc+0x5ac>
     b2c:	5d0040ef          	jal	50fc <printf>
        exit(1);
     b30:	4505                	li	a0,1
     ...
     b3e:	c4e50513          	addi	a0,a0,-946 # 5788 <malloc+0x5d4>
     b42:	5ba040ef          	jal	50fc <printf>
      exit(1);
     b46:	4505                	li	a0,1
     ...
     b54:	c5050513          	addi	a0,a0,-944 # 57a0 <malloc+0x5ec>
     b58:	5a4040ef          	jal	50fc <printf>
      exit(1);
     b5c:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b68:	c6450513          	addi	a0,a0,-924 # 57c8 <malloc+0x614>
     b6c:	590040ef          	jal	50fc <printf>
    exit(1);
     b70:	4505                	li	a0,1
...
0000000000000b76 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b8e:	c5650513          	addi	a0,a0,-938 # 57e0 <malloc+0x62c>
  ...
  write(fd, "hello", SZ);
     ...
     ba2:	c7258593          	addi	a1,a1,-910 # 5810 <malloc+0x65c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb6:	c2e50513          	addi	a0,a0,-978 # 57e0 <malloc+0x62c>
  ...
  unlink("unlinkread");
     ...
     c3e:	ba650513          	addi	a0,a0,-1114 # 57e0 <malloc+0x62c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c5a:	b9a50513          	addi	a0,a0,-1126 # 57f0 <malloc+0x63c>
     c5e:	49e040ef          	jal	50fc <printf>
    exit(1);
     c62:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c6e:	bae50513          	addi	a0,a0,-1106 # 5818 <malloc+0x664>
     c72:	48a040ef          	jal	50fc <printf>
    exit(1);
     c76:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c82:	bba50513          	addi	a0,a0,-1094 # 5838 <malloc+0x684>
     c86:	476040ef          	jal	50fc <printf>
    exit(1);
     c8a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c96:	bce50513          	addi	a0,a0,-1074 # 5860 <malloc+0x6ac>
     c9a:	462040ef          	jal	50fc <printf>
    exit(1);
     c9e:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     caa:	bda50513          	addi	a0,a0,-1062 # 5880 <malloc+0x6cc>
     cae:	44e040ef          	jal	50fc <printf>
    exit(1);
     cb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cbe:	be650513          	addi	a0,a0,-1050 # 58a0 <malloc+0x6ec>
     cc2:	43a040ef          	jal	50fc <printf>
    exit(1);
     cc6:	4505                	li	a0,1
...
0000000000000ccc <linktest>:
{
  ...
  unlink("lf1");
     ...
     cde:	be650513          	addi	a0,a0,-1050 # 58c0 <malloc+0x70c>
     ce2:	060040ef          	jal	4d42 <unlink>
  unlink("lf2");
     ce6:	00005517          	auipc	a0,0x5
     cea:	be250513          	addi	a0,a0,-1054 # 58c8 <malloc+0x714>
     cee:	054040ef          	jal	4d42 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     cf2:	20200593          	li	a1,514
     cf6:	00005517          	auipc	a0,0x5
     cfa:	bca50513          	addi	a0,a0,-1078 # 58c0 <malloc+0x70c>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d0e:	b0658593          	addi	a1,a1,-1274 # 5810 <malloc+0x65c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     de6:	aee50513          	addi	a0,a0,-1298 # 58d0 <malloc+0x71c>
     dea:	312040ef          	jal	50fc <printf>
    exit(1);
     dee:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     dfa:	af250513          	addi	a0,a0,-1294 # 58e8 <malloc+0x734>
     dfe:	2fe040ef          	jal	50fc <printf>
    exit(1);
     e02:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     e0e:	af650513          	addi	a0,a0,-1290 # 5900 <malloc+0x74c>
     e12:	2ea040ef          	jal	50fc <printf>
    exit(1);
     e16:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     e22:	b0250513          	addi	a0,a0,-1278 # 5920 <malloc+0x76c>
     e26:	2d6040ef          	jal	50fc <printf>
    exit(1);
     e2a:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     e36:	b1e50513          	addi	a0,a0,-1250 # 5950 <malloc+0x79c>
     e3a:	2c2040ef          	jal	50fc <printf>
    exit(1);
     e3e:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     e4a:	b2250513          	addi	a0,a0,-1246 # 5968 <malloc+0x7b4>
     e4e:	2ae040ef          	jal	50fc <printf>
    exit(1);
     e52:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e5e:	b2650513          	addi	a0,a0,-1242 # 5980 <malloc+0x7cc>
     e62:	29a040ef          	jal	50fc <printf>
    exit(1);
     e66:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e72:	b3a50513          	addi	a0,a0,-1222 # 59a8 <malloc+0x7f4>
     e76:	286040ef          	jal	50fc <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e86:	b5650513          	addi	a0,a0,-1194 # 59d8 <malloc+0x824>
     e8a:	272040ef          	jal	50fc <printf>
    exit(1);
     e8e:	4505                	li	a0,1
...
0000000000000e94 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     eb0:	b4c98993          	addi	s3,s3,-1204 # 59f8 <malloc+0x844>
     eb4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     eb6:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     ee8:	b2450513          	addi	a0,a0,-1244 # 5a08 <malloc+0x854>
     eec:	210040ef          	jal	50fc <printf>
      exit(1);
     ef0:	4505                	li	a0,1
...
0000000000000ef6 <bigdir>:
{
  ...
  unlink("bd");
     ...
     f12:	b1a50513          	addi	a0,a0,-1254 # 5a28 <malloc+0x874>
     f16:	62d030ef          	jal	4d42 <unlink>
  fd = open("bd", O_CREATE);
     f1a:	20000593          	li	a1,512
     f1e:	00005517          	auipc	a0,0x5
     f22:	b0a50513          	addi	a0,a0,-1270 # 5a28 <malloc+0x874>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     f40:	aeca0a13          	addi	s4,s4,-1300 # 5a28 <malloc+0x874>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f8c:	aa050513          	addi	a0,a0,-1376 # 5a28 <malloc+0x874>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     ff8:	a3c50513          	addi	a0,a0,-1476 # 5a30 <malloc+0x87c>
     ffc:	100040ef          	jal	50fc <printf>
    exit(1);
    1000:	4505                	li	a0,1
    ...
    1012:	a4250513          	addi	a0,a0,-1470 # 5a50 <malloc+0x89c>
    1016:	0e6040ef          	jal	50fc <printf>
      exit(1);
    101a:	4505                	li	a0,1
    ...
    1026:	a5650513          	addi	a0,a0,-1450 # 5a78 <malloc+0x8c4>
    102a:	0d2040ef          	jal	50fc <printf>
      exit(1);
    102e:	4505                	li	a0,1
...
0000000000001060 <badarg>:
{
    ...
    1084:	26898993          	addi	s3,s3,616 # 52e8 <malloc+0x134>
    argv[0] = (char*)0xffffffff;
...
00000000000010a2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    10f8:	c0478793          	addi	a5,a5,-1020 # 6cf8 <malloc+0x1b44>
  ...
  if(pid == 0){
    ...
    114c:	5e078793          	addi	a5,a5,1504 # 7728 <malloc+0x2574>
    ...
    1170:	17c50513          	addi	a0,a0,380 # 52e8 <malloc+0x134>
    ...
    1184:	9a050513          	addi	a0,a0,-1632 # 5b20 <malloc+0x96c>
    1188:	775030ef          	jal	50fc <printf>
      exit(1);
    118c:	4505                	li	a0,1
    ...
    119c:	90050513          	addi	a0,a0,-1792 # 5a98 <malloc+0x8e4>
    11a0:	75d030ef          	jal	50fc <printf>
    exit(1);
    11a4:	4505                	li	a0,1
    ...
    11b4:	90850513          	addi	a0,a0,-1784 # 5ab8 <malloc+0x904>
    11b8:	745030ef          	jal	50fc <printf>
    exit(1);
    11bc:	4505                	li	a0,1
    ...
    11ce:	90e50513          	addi	a0,a0,-1778 # 5ad8 <malloc+0x924>
    11d2:	72b030ef          	jal	50fc <printf>
    exit(1);
    11d6:	4505                	li	a0,1
    ...
    11e6:	91e50513          	addi	a0,a0,-1762 # 5b00 <malloc+0x94c>
    11ea:	713030ef          	jal	50fc <printf>
    exit(1);
    11ee:	4505                	li	a0,1
    11f0:	303030ef          	jal	4cf2 <exit>
    printf("fork failed\n");
    11f4:	00005517          	auipc	a0,0x5
    11f8:	d8c50513          	addi	a0,a0,-628 # 5f80 <malloc+0xdcc>
    11fc:	701030ef          	jal	50fc <printf>
    exit(1);
    1200:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1232:	91a50513          	addi	a0,a0,-1766 # 5b48 <malloc+0x994>
    1236:	6c7030ef          	jal	50fc <printf>
    exit(1);
    123a:	4505                	li	a0,1
...
0000000000001240 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    1254:	0f050513          	addi	a0,a0,240 # 5340 <malloc+0x18c>
  ...
  if(pid == 0){
    ...
    1284:	0c098993          	addi	s3,s3,192 # 5340 <malloc+0x18c>
      int n = write(fd, "1234567890", 10);
    1288:	4a29                	li	s4,10
    128a:	00005b97          	auipc	s7,0x5
    128e:	91eb8b93          	addi	s7,s7,-1762 # 5ba8 <malloc+0x9f4>
    ...
    12f4:	88850513          	addi	a0,a0,-1912 # 5b78 <malloc+0x9c4>
    12f8:	605030ef          	jal	50fc <printf>
    exit(1);
    12fc:	4505                	li	a0,1
    ...
    1308:	88c50513          	addi	a0,a0,-1908 # 5b90 <malloc+0x9dc>
    130c:	5f1030ef          	jal	50fc <printf>
        exit(1);
    1310:	4505                	li	a0,1
    ...
    131e:	89e50513          	addi	a0,a0,-1890 # 5bb8 <malloc+0xa04>
    1322:	5db030ef          	jal	50fc <printf>
        exit(1);
    1326:	4505                	li	a0,1
    ...
    134e:	88eb8b93          	addi	s7,s7,-1906 # 5bd8 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    1352:	85da                	mv	a1,s6
    1354:	8552                	mv	a0,s4
  ...
  unlink("truncfile");
    ...
    1388:	fbc50513          	addi	a0,a0,-68 # 5340 <malloc+0x18c>
  ...
  exit(xstatus);
    ...
    13a2:	7f250513          	addi	a0,a0,2034 # 5b90 <malloc+0x9dc>
    13a6:	557030ef          	jal	50fc <printf>
      exit(1);
    13aa:	4505                	li	a0,1
    ...
    13bc:	82850513          	addi	a0,a0,-2008 # 5be0 <malloc+0xa2c>
    13c0:	53d030ef          	jal	50fc <printf>
      exit(1);
    13c4:	4505                	li	a0,1
...
00000000000013ca <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    13da:	f1278793          	addi	a5,a5,-238 # 52e8 <malloc+0x134>
    13de:	fcf43023          	sd	a5,-64(s0)
    13e2:	00005797          	auipc	a5,0x5
    13e6:	81e78793          	addi	a5,a5,-2018 # 5c00 <malloc+0xa4c>
    13ea:	fcf43423          	sd	a5,-56(s0)
    13ee:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    13f2:	00005517          	auipc	a0,0x5
    13f6:	81650513          	addi	a0,a0,-2026 # 5c08 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    141a:	7f250513          	addi	a0,a0,2034 # 5c08 <malloc+0xa54>
    ...
    1432:	7fa50513          	addi	a0,a0,2042 # 5c28 <malloc+0xa74>
    1436:	4c7030ef          	jal	50fc <printf>
      exit(1);
    143a:	4505                	li	a0,1
    ...
    1448:	73450513          	addi	a0,a0,1844 # 5b78 <malloc+0x9c4>
    144c:	4b1030ef          	jal	50fc <printf>
     exit(1);
    1450:	4505                	li	a0,1
    ...
    145c:	7b850513          	addi	a0,a0,1976 # 5c10 <malloc+0xa5c>
    1460:	49d030ef          	jal	50fc <printf>
      exit(1);
    1464:	4505                	li	a0,1
    ...
    1472:	e7a50513          	addi	a0,a0,-390 # 52e8 <malloc+0x134>
  ...
  if(xstatus != 0)
    ...
    149a:	7a250513          	addi	a0,a0,1954 # 5c38 <malloc+0xa84>
    149e:	45f030ef          	jal	50fc <printf>
      exit(1);
    14a2:	4505                	li	a0,1
    ...
    14ae:	7a650513          	addi	a0,a0,1958 # 5c50 <malloc+0xa9c>
    14b2:	44b030ef          	jal	50fc <printf>
    14b6:	bfd1                	j	148a <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    14b8:	4581                	li	a1,0
    14ba:	00004517          	auipc	a0,0x4
    14be:	74e50513          	addi	a0,a0,1870 # 5c08 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    14e0:	1dc50513          	addi	a0,a0,476 # 56b8 <malloc+0x504>
    14e4:	419030ef          	jal	50fc <printf>
    exit(1);
    14e8:	4505                	li	a0,1
    ...
    14f4:	6a050513          	addi	a0,a0,1696 # 5b90 <malloc+0x9dc>
    14f8:	405030ef          	jal	50fc <printf>
    exit(1);
    14fc:	4505                	li	a0,1
    14fe:	7f4030ef          	jal	4cf2 <exit>
  unlink("echo-ok");
    1502:	00004517          	auipc	a0,0x4
    1506:	70650513          	addi	a0,a0,1798 # 5c08 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    152c:	74050513          	addi	a0,a0,1856 # 5c68 <malloc+0xab4>
    1530:	3cd030ef          	jal	50fc <printf>
    exit(1);
    1534:	4505                	li	a0,1
...
0000000000001540 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    15d6:	6ae50513          	addi	a0,a0,1710 # 5c80 <malloc+0xacc>
    15da:	323030ef          	jal	50fc <printf>
    exit(1);
    15de:	4505                	li	a0,1
    ...
    1612:	42db0b13          	addi	s6,s6,1069 # 142d <exectest+0x63>
{
    ...
    1626:	409a0a1b          	addiw	s4,s4,1033 # 5749 <malloc+0x595>
      if(write(fds[1], buf, SZ) != SZ){
    162a:	8656                	mv	a2,s5
    162c:	85e2                	mv	a1,s8
    ...
    1650:	64c50513          	addi	a0,a0,1612 # 5c98 <malloc+0xae4>
    1654:	2a9030ef          	jal	50fc <printf>
        exit(1);
    1658:	4505                	li	a0,1
    ...
    1664:	65050513          	addi	a0,a0,1616 # 5cb0 <malloc+0xafc>
    1668:	295030ef          	jal	50fc <printf>
          return;
    ...
    1696:	63650513          	addi	a0,a0,1590 # 5cc8 <malloc+0xb14>
    169a:	263030ef          	jal	50fc <printf>
      exit(1);
    169e:	4505                	li	a0,1
    ...
    16d2:	61a50513          	addi	a0,a0,1562 # 5ce8 <malloc+0xb34>
    16d6:	227030ef          	jal	50fc <printf>
    exit(1);
    16da:	4505                	li	a0,1
...
00000000000016e0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    173a:	44250513          	addi	a0,a0,1090 # 5b78 <malloc+0x9c4>
    173e:	1bf030ef          	jal	50fc <printf>
      exit(1);
    1742:	4505                	li	a0,1
    ...
    174e:	5b650513          	addi	a0,a0,1462 # 5d00 <malloc+0xb4c>
    1752:	1ab030ef          	jal	50fc <printf>
        exit(1);
    1756:	4505                	li	a0,1
    ...
    1762:	5ba50513          	addi	a0,a0,1466 # 5d18 <malloc+0xb64>
    1766:	197030ef          	jal	50fc <printf>
        exit(1);
    176a:	4505                	li	a0,1
...
0000000000001776 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    17be:	3be50513          	addi	a0,a0,958 # 5b78 <malloc+0x9c4>
    17c2:	13b030ef          	jal	50fc <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    ...
    17d6:	3a650513          	addi	a0,a0,934 # 5b78 <malloc+0x9c4>
    17da:	123030ef          	jal	50fc <printf>
        exit(1);
    17de:	4505                	li	a0,1
...
00000000000017e8 <forkfork>:
{
    ...
    1834:	50850513          	addi	a0,a0,1288 # 5d38 <malloc+0xb84>
    1838:	0c5030ef          	jal	50fc <printf>
      exit(1);
    183c:	4505                	li	a0,1
    183e:	4b4030ef          	jal	4cf2 <exit>
{
    ...
    1870:	4dc50513          	addi	a0,a0,1244 # 5d48 <malloc+0xb94>
    1874:	089030ef          	jal	50fc <printf>
      exit(1);
    1878:	4505                	li	a0,1
...
000000000000187e <reparent2>:
{
  ...
  exit(0);
    ...
    18aa:	6da50513          	addi	a0,a0,1754 # 5f80 <malloc+0xdcc>
    18ae:	04f030ef          	jal	50fc <printf>
      exit(1);
    18b2:	4505                	li	a0,1
...
00000000000018c6 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1930:	24c50513          	addi	a0,a0,588 # 5b78 <malloc+0x9c4>
    1934:	7c8030ef          	jal	50fc <printf>
      exit(1);
    1938:	4505                	li	a0,1
    ...
    195c:	2b850513          	addi	a0,a0,696 # 5c10 <malloc+0xa5c>
    1960:	79c030ef          	jal	50fc <printf>
          exit(1);
    1964:	4505                	li	a0,1
    ...
    19bc:	3b050513          	addi	a0,a0,944 # 5d68 <malloc+0xbb4>
    19c0:	73c030ef          	jal	50fc <printf>
            exit(1);
    19c4:	4505                	li	a0,1
    ...
    19da:	3aa50513          	addi	a0,a0,938 # 5d80 <malloc+0xbcc>
    19de:	71e030ef          	jal	50fc <printf>
        exit(1);
    19e2:	4505                	li	a0,1
    ...
    1a2a:	38250513          	addi	a0,a0,898 # 5da8 <malloc+0xbf4>
    1a2e:	6ce030ef          	jal	50fc <printf>
        exit(1);
    1a32:	4505                	li	a0,1
...
0000000000001aa4 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1ac6:	89650513          	addi	a0,a0,-1898 # 5358 <malloc+0x1a4>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b06:	856b0b13          	addi	s6,s6,-1962 # 5358 <malloc+0x1a4>
      link("cat", "x");
    1b0a:	00004c97          	auipc	s9,0x4
    1b0e:	2c6c8c93          	addi	s9,s9,710 # 5dd0 <malloc+0xc1c>
    ...
    1b1e:	05e50513          	addi	a0,a0,94 # 5b78 <malloc+0x9c4>
    1b22:	5da030ef          	jal	50fc <printf>
    exit(1);
    1b26:	4505                	li	a0,1
...
0000000000001b9e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1bca:	25a50513          	addi	a0,a0,602 # 5e20 <malloc+0xc6c>
    1bce:	52e030ef          	jal	50fc <printf>
    exit(1);
    1bd2:	4505                	li	a0,1
    ...
    1be2:	1fa50513          	addi	a0,a0,506 # 5dd8 <malloc+0xc24>
    1be6:	516030ef          	jal	50fc <printf>
    exit(1);
    1bea:	4505                	li	a0,1
    ...
    1bf6:	1fe50513          	addi	a0,a0,510 # 5df0 <malloc+0xc3c>
    1bfa:	502030ef          	jal	50fc <printf>
      exit(1);
    1bfe:	4505                	li	a0,1
    ...
    1c0a:	20250513          	addi	a0,a0,514 # 5e08 <malloc+0xc54>
    1c0e:	4ee030ef          	jal	50fc <printf>
    exit(1);
    1c12:	4505                	li	a0,1
...
0000000000001c44 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1cac:	ed050513          	addi	a0,a0,-304 # 5b78 <malloc+0x9c4>
    1cb0:	44c030ef          	jal	50fc <printf>
      exit(1);
    1cb4:	4505                	li	a0,1
    ...
    1cc6:	18650513          	addi	a0,a0,390 # 5e48 <malloc+0xc94>
    1cca:	432030ef          	jal	50fc <printf>
      exit(1);
    1cce:	4505                	li	a0,1
...
0000000000001cda <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1d3a:	e4250513          	addi	a0,a0,-446 # 5b78 <malloc+0x9c4>
    1d3e:	3be030ef          	jal	50fc <printf>
      exit(1);
    1d42:	4505                	li	a0,1
    ...
    1d5e:	10e50513          	addi	a0,a0,270 # 5e68 <malloc+0xcb4>
    1d62:	39a030ef          	jal	50fc <printf>
      exit(1);
    1d66:	4505                	li	a0,1
...
0000000000001d72 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    1d82:	10250513          	addi	a0,a0,258 # 5e80 <malloc+0xccc>
  ...
  fd = open("bigarg-ok", 0);
    ...
    1da8:	0dc50513          	addi	a0,a0,220 # 5e80 <malloc+0xccc>
  ...
  close(fd);
    ...
    1dd6:	0be70713          	addi	a4,a4,190 # 5e90 <malloc+0xcdc>
    ...
    1df2:	4fa50513          	addi	a0,a0,1274 # 52e8 <malloc+0x134>
    1df6:	735020ef          	jal	4d2a <exec>
    fd = open("bigarg-ok", O_CREATE);
    1dfa:	20000593          	li	a1,512
    1dfe:	00004517          	auipc	a0,0x4
    1e02:	08250513          	addi	a0,a0,130 # 5e80 <malloc+0xccc>
    ...
    1e1a:	15a50513          	addi	a0,a0,346 # 5f70 <malloc+0xdbc>
    1e1e:	2de030ef          	jal	50fc <printf>
    exit(1);
    1e22:	4505                	li	a0,1
    ...
    1e32:	16250513          	addi	a0,a0,354 # 5f90 <malloc+0xddc>
    1e36:	2c6030ef          	jal	50fc <printf>
    exit(1);
    1e3a:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1e7c:	13850513          	addi	a0,a0,312 # 5fb0 <malloc+0xdfc>
    1e80:	27c030ef          	jal	50fc <printf>
    exit(1);
    1e84:	4505                	li	a0,1
    ...
    1e90:	cec50513          	addi	a0,a0,-788 # 5b78 <malloc+0x9c4>
    1e94:	268030ef          	jal	50fc <printf>
    exit(1);
    1e98:	4505                	li	a0,1
...
0000000000001ea4 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1eba:	87278793          	addi	a5,a5,-1934 # 7728 <malloc+0x2574>
  ...
  exit(0);
    ...
    1f24:	0b850513          	addi	a0,a0,184 # 5fd8 <malloc+0xe24>
    1f28:	1d4030ef          	jal	50fc <printf>
      exit(0);
    1f2c:	4501                	li	a0,0
    ...
    1f38:	c4450513          	addi	a0,a0,-956 # 5b78 <malloc+0x9c4>
    1f3c:	1c0030ef          	jal	50fc <printf>
      exit(1);
    1f40:	4505                	li	a0,1
...
0000000000001f4c <manywrites>:
{
  ...
  exit(0);
    ...
    1fb2:	fd250513          	addi	a0,a0,-46 # 5f80 <malloc+0xdcc>
    1fb6:	146030ef          	jal	50fc <printf>
      exit(1);
    1fba:	4505                	li	a0,1
    ...
    204a:	fb250513          	addi	a0,a0,-78 # 5ff8 <malloc+0xe44>
    204e:	0ae030ef          	jal	50fc <printf>
            exit(1);
    2052:	4505                	li	a0,1
    ...
    2062:	35a50513          	addi	a0,a0,858 # 53b8 <malloc+0x204>
    2066:	096030ef          	jal	50fc <printf>
            exit(1);
    206a:	4505                	li	a0,1
...
0000000000002080 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    20e2:	c1a78793          	addi	a5,a5,-998 # 6cf8 <malloc+0x1b44>
  ...
  if(ret != -1){
    ...
    211e:	ef650513          	addi	a0,a0,-266 # 6010 <malloc+0xe5c>
    2122:	7db020ef          	jal	50fc <printf>
    exit(1);
    2126:	4505                	li	a0,1
    ...
    2134:	96850513          	addi	a0,a0,-1688 # 5a98 <malloc+0x8e4>
    2138:	7c5020ef          	jal	50fc <printf>
    exit(1);
    213c:	4505                	li	a0,1
    ...
    214a:	97250513          	addi	a0,a0,-1678 # 5ab8 <malloc+0x904>
    214e:	7af020ef          	jal	50fc <printf>
    exit(1);
    2152:	4505                	li	a0,1
    ...
    2162:	97a50513          	addi	a0,a0,-1670 # 5ad8 <malloc+0x924>
    2166:	797020ef          	jal	50fc <printf>
    exit(1);
    216a:	4505                	li	a0,1
    ...
    2178:	98c50513          	addi	a0,a0,-1652 # 5b00 <malloc+0x94c>
    217c:	781020ef          	jal	50fc <printf>
    exit(1);
    2180:	4505                	li	a0,1
...
0000000000002186 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    21b4:	ea050513          	addi	a0,a0,-352 # 6050 <malloc+0xe9c>
  ...
  if(n >= 0){
    ...
    21dc:	e9850513          	addi	a0,a0,-360 # 6070 <malloc+0xebc>
    21e0:	71d020ef          	jal	50fc <printf>
    exit(1);
    21e4:	4505                	li	a0,1
    ...
    21f2:	e2a50513          	addi	a0,a0,-470 # 6018 <malloc+0xe64>
    21f6:	707020ef          	jal	50fc <printf>
    exit(1);
    21fa:	4505                	li	a0,1
    ...
    2206:	e2e50513          	addi	a0,a0,-466 # 6030 <malloc+0xe7c>
    220a:	6f3020ef          	jal	50fc <printf>
    exit(1);
    220e:	4505                	li	a0,1
    2210:	2e3020ef          	jal	4cf2 <exit>
    printf("open(rwsbrk) failed\n");
    2214:	00004517          	auipc	a0,0x4
    2218:	e4450513          	addi	a0,a0,-444 # 6058 <malloc+0xea4>
    221c:	6e1020ef          	jal	50fc <printf>
    exit(1);
    2220:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2230:	e2450513          	addi	a0,a0,-476 # 6050 <malloc+0xe9c>
    2234:	30f020ef          	jal	4d42 <unlink>
  fd = open("README", O_RDONLY);
    2238:	4581                	li	a1,0
    223a:	00003517          	auipc	a0,0x3
    223e:	28650513          	addi	a0,a0,646 # 54c0 <malloc+0x30c>
  ...
  if(n >= 0){
    ...
    2260:	e4450513          	addi	a0,a0,-444 # 60a0 <malloc+0xeec>
    2264:	699020ef          	jal	50fc <printf>
    exit(1);
    2268:	4505                	li	a0,1
    226a:	289020ef          	jal	4cf2 <exit>
    printf("open(rwsbrk) failed\n");
    226e:	00004517          	auipc	a0,0x4
    2272:	dea50513          	addi	a0,a0,-534 # 6058 <malloc+0xea4>
    2276:	687020ef          	jal	50fc <printf>
    exit(1);
    227a:	4505                	li	a0,1
...
000000000000228c <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    22e0:	dec50513          	addi	a0,a0,-532 # 60c8 <malloc+0xf14>
    22e4:	619020ef          	jal	50fc <printf>
    exit(1);
    22e8:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2338:	db450513          	addi	a0,a0,-588 # 60e8 <malloc+0xf34>
    233c:	5c1020ef          	jal	50fc <printf>
    exit(1);
    2340:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2382:	dca50513          	addi	a0,a0,-566 # 6148 <malloc+0xf94>
    2386:	577020ef          	jal	50fc <printf>
    exit(1);
    238a:	4505                	li	a0,1
    ...
    239c:	d7050513          	addi	a0,a0,-656 # 6108 <malloc+0xf54>
    23a0:	55d020ef          	jal	50fc <printf>
      exit(1);
    23a4:	4505                	li	a0,1
    ...
    23b0:	d7c50513          	addi	a0,a0,-644 # 6128 <malloc+0xf74>
    23b4:	549020ef          	jal	50fc <printf>
    exit(1);
    23b8:	4505                	li	a0,1
...
00000000000023d8 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    24b2:	cba50513          	addi	a0,a0,-838 # 6168 <malloc+0xfb4>
    24b6:	447020ef          	jal	50fc <printf>
    exit(1);
    24ba:	4505                	li	a0,1
    ...
    24c6:	cee50513          	addi	a0,a0,-786 # 61b0 <malloc+0xffc>
    24ca:	433020ef          	jal	50fc <printf>
    exit(1);
    24ce:	4505                	li	a0,1
    ...
    24de:	cf650513          	addi	a0,a0,-778 # 61d0 <malloc+0x101c>
    24e2:	41b020ef          	jal	50fc <printf>
    exit(1);
    24e6:	4505                	li	a0,1
    ...
    24f6:	d1e50513          	addi	a0,a0,-738 # 6210 <malloc+0x105c>
    24fa:	403020ef          	jal	50fc <printf>
    exit(1);
    24fe:	4505                	li	a0,1
    ...
    250a:	d3a50513          	addi	a0,a0,-710 # 6240 <malloc+0x108c>
    250e:	3ef020ef          	jal	50fc <printf>
    exit(1);
    2512:	4505                	li	a0,1
    ...
    2522:	d5a50513          	addi	a0,a0,-678 # 6278 <malloc+0x10c4>
    2526:	3d7020ef          	jal	50fc <printf>
    exit(1);
    252a:	4505                	li	a0,1
...
0000000000002530 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2550:	d5450513          	addi	a0,a0,-684 # 62a0 <malloc+0x10ec>
    2554:	7de020ef          	jal	4d32 <open>
    2558:	84aa                	mv	s1,a0
  unlink("sbrk");
    255a:	00004517          	auipc	a0,0x4
    255e:	d4650513          	addi	a0,a0,-698 # 62a0 <malloc+0x10ec>
  ...
  if(pipe((int *) a) != 0){
    ...
    259e:	d0e50513          	addi	a0,a0,-754 # 62a8 <malloc+0x10f4>
    25a2:	35b020ef          	jal	50fc <printf>
    exit(1);
    25a6:	4505                	li	a0,1
    ...
    25b2:	d1250513          	addi	a0,a0,-750 # 62c0 <malloc+0x110c>
    25b6:	347020ef          	jal	50fc <printf>
    exit(1);
    25ba:	4505                	li	a0,1
    ...
    25c6:	6be50513          	addi	a0,a0,1726 # 5c80 <malloc+0xacc>
    25ca:	333020ef          	jal	50fc <printf>
    exit(1);
    25ce:	4505                	li	a0,1
...
00000000000025d4 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    25e8:	cf450513          	addi	a0,a0,-780 # 62d8 <malloc+0x1124>
  ...
  close(fd);
    ...
    2620:	57450513          	addi	a0,a0,1396 # 5b90 <malloc+0x9dc>
    2624:	2d9020ef          	jal	50fc <printf>
    exit(1);
    2628:	4505                	li	a0,1
...
000000000000262e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2656:	92e50513          	addi	a0,a0,-1746 # 5f80 <malloc+0xdcc>
    265a:	2a3020ef          	jal	50fc <printf>
    exit(1);
    265e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2690:	8f450513          	addi	a0,a0,-1804 # 5f80 <malloc+0xdcc>
    2694:	269020ef          	jal	50fc <printf>
    exit(1);
    2698:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    26d0:	8b450513          	addi	a0,a0,-1868 # 5f80 <malloc+0xdcc>
    26d4:	229020ef          	jal	50fc <printf>
    exit(1);
    26d8:	4505                	li	a0,1
...
00000000000027bc <execout>:
{
  ...
  exit(0);
    ...
    27f8:	78c50513          	addi	a0,a0,1932 # 5f80 <malloc+0xdcc>
    27fc:	101020ef          	jal	50fc <printf>
      exit(1);
    2800:	4505                	li	a0,1
    ...
    283e:	aae50513          	addi	a0,a0,-1362 # 52e8 <malloc+0x134>
    2842:	faa43423          	sd	a0,-88(s0)
    2846:	00003797          	auipc	a5,0x3
    284a:	b1278793          	addi	a5,a5,-1262 # 5358 <malloc+0x1a4>
...
0000000000002864 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2894:	ad050513          	addi	a0,a0,-1328 # 6360 <malloc+0x11ac>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    28aa:	b3250513          	addi	a0,a0,-1230 # 63d8 <malloc+0x1224>
  ...
  unlink("12345678901234");
    ...
    292e:	9b650513          	addi	a0,a0,-1610 # 62e0 <malloc+0x112c>
    2932:	7ca020ef          	jal	50fc <printf>
    exit(1);
    2936:	4505                	li	a0,1
    ...
    2942:	9ea50513          	addi	a0,a0,-1558 # 6328 <malloc+0x1174>
    2946:	7b6020ef          	jal	50fc <printf>
    exit(1);
    294a:	4505                	li	a0,1
    ...
    2956:	a3e50513          	addi	a0,a0,-1474 # 6390 <malloc+0x11dc>
    295a:	7a2020ef          	jal	50fc <printf>
    exit(1);
    295e:	4505                	li	a0,1
    ...
    296a:	aa250513          	addi	a0,a0,-1374 # 6408 <malloc+0x1254>
    296e:	78e020ef          	jal	50fc <printf>
    exit(1);
    2972:	4505                	li	a0,1
    ...
    297e:	aee50513          	addi	a0,a0,-1298 # 6468 <malloc+0x12b4>
    2982:	77a020ef          	jal	50fc <printf>
    exit(1);
    2986:	4505                	li	a0,1
    ...
    2992:	b3250513          	addi	a0,a0,-1230 # 64c0 <malloc+0x130c>
    2996:	766020ef          	jal	50fc <printf>
    exit(1);
    299a:	4505                	li	a0,1
...
00000000000029a0 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    29e4:	b1850513          	addi	a0,a0,-1256 # 64f8 <malloc+0x1344>
    ...
    2a1a:	af250513          	addi	a0,a0,-1294 # 6508 <malloc+0x1354>
    2a1e:	6de020ef          	jal	50fc <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    2a92:	a6a50513          	addi	a0,a0,-1430 # 64f8 <malloc+0x1344>
    2a96:	2c4020ef          	jal	4d5a <mkdir>
    2a9a:	12050363          	beqz	a0,2bc0 <diskfull+0x220>
  unlink("diskfulldir");
    2a9e:	00004517          	auipc	a0,0x4
    2aa2:	a5a50513          	addi	a0,a0,-1446 # 64f8 <malloc+0x1344>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2bc8:	96450513          	addi	a0,a0,-1692 # 6528 <malloc+0x1374>
    2bcc:	530020ef          	jal	50fc <printf>
...
0000000000002bd2 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2c2e:	93650513          	addi	a0,a0,-1738 # 6560 <malloc+0x13ac>
    2c32:	4ca020ef          	jal	50fc <printf>
    exit(1);
    2c36:	4505                	li	a0,1
    ...
    2c42:	93a50513          	addi	a0,a0,-1734 # 6578 <malloc+0x13c4>
    2c46:	4b6020ef          	jal	50fc <printf>
    exit(1);
    2c4a:	4505                	li	a0,1
    ...
    2c56:	95650513          	addi	a0,a0,-1706 # 65a8 <malloc+0x13f4>
    2c5a:	4a2020ef          	jal	50fc <printf>
    exit(1);
    2c5e:	4505                	li	a0,1
    ...
    2c6a:	96a50513          	addi	a0,a0,-1686 # 65d0 <malloc+0x141c>
    2c6e:	48e020ef          	jal	50fc <printf>
    exit(1);
    2c72:	4505                	li	a0,1
...
0000000000002c78 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2cca:	eb250513          	addi	a0,a0,-334 # 5b78 <malloc+0x9c4>
    2cce:	42e020ef          	jal	50fc <printf>
    exit(1);
    2cd2:	4505                	li	a0,1
    ...
    2cde:	88650513          	addi	a0,a0,-1914 # 6560 <malloc+0x13ac>
    2ce2:	41a020ef          	jal	50fc <printf>
      exit(1);
    2ce6:	4505                	li	a0,1
    ...
    2cf2:	8fa50513          	addi	a0,a0,-1798 # 65e8 <malloc+0x1434>
    2cf6:	406020ef          	jal	50fc <printf>
      exit(1);
    2cfa:	4505                	li	a0,1
    ...
    2d06:	8a650513          	addi	a0,a0,-1882 # 65a8 <malloc+0x13f4>
    2d0a:	3f2020ef          	jal	50fc <printf>
      exit(1);
    2d0e:	4505                	li	a0,1
...
0000000000002d24 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2d80:	7e450513          	addi	a0,a0,2020 # 6560 <malloc+0x13ac>
    2d84:	378020ef          	jal	50fc <printf>
    exit(1);
    2d88:	4505                	li	a0,1
    ...
    2d94:	87850513          	addi	a0,a0,-1928 # 6608 <malloc+0x1454>
    2d98:	364020ef          	jal	50fc <printf>
    exit(1);
    2d9c:	4505                	li	a0,1
    ...
    2da8:	88450513          	addi	a0,a0,-1916 # 6628 <malloc+0x1474>
    2dac:	350020ef          	jal	50fc <printf>
    exit(1);
    2db0:	4505                	li	a0,1
    ...
    2dbc:	88850513          	addi	a0,a0,-1912 # 6640 <malloc+0x148c>
    2dc0:	33c020ef          	jal	50fc <printf>
    exit(1);
    2dc4:	4505                	li	a0,1
...
0000000000002dca <subdir>:
{
  ...
  unlink("ff");
    ...
    2ddc:	9b050513          	addi	a0,a0,-1616 # 6788 <malloc+0x15d4>
    2de0:	763010ef          	jal	4d42 <unlink>
  if(mkdir("dd") != 0){
    2de4:	00004517          	auipc	a0,0x4
    2de8:	87450513          	addi	a0,a0,-1932 # 6658 <malloc+0x14a4>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2dfc:	88050513          	addi	a0,a0,-1920 # 6678 <malloc+0x14c4>
  ...
  write(fd, "ff", 2);
    ...
    2e10:	97c58593          	addi	a1,a1,-1668 # 6788 <malloc+0x15d4>
  ...
  if(unlink("dd") >= 0){
    ...
    2e22:	83a50513          	addi	a0,a0,-1990 # 6658 <malloc+0x14a4>
    2e26:	71d010ef          	jal	4d42 <unlink>
    2e2a:	2c055963          	bgez	a0,30fc <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2e2e:	00004517          	auipc	a0,0x4
    2e32:	8a250513          	addi	a0,a0,-1886 # 66d0 <malloc+0x151c>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2e46:	8b650513          	addi	a0,a0,-1866 # 66f8 <malloc+0x1544>
  ...
  write(fd, "FF", 2);
    ...
    2e5a:	8d258593          	addi	a1,a1,-1838 # 6728 <malloc+0x1574>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2e6e:	8c650513          	addi	a0,a0,-1850 # 6730 <malloc+0x157c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2f54:	7a850513          	addi	a0,a0,1960 # 66f8 <malloc+0x1544>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2f68:	9ac50513          	addi	a0,a0,-1620 # 6910 <malloc+0x175c>
  ...
  if(unlink("dd") < 0){
    ...
    30da:	58a50513          	addi	a0,a0,1418 # 6660 <malloc+0x14ac>
    30de:	01e020ef          	jal	50fc <printf>
    exit(1);
    30e2:	4505                	li	a0,1
    ...
    30ee:	59650513          	addi	a0,a0,1430 # 6680 <malloc+0x14cc>
    30f2:	00a020ef          	jal	50fc <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    ...
    3102:	5a250513          	addi	a0,a0,1442 # 66a0 <malloc+0x14ec>
    3106:	7f7010ef          	jal	50fc <printf>
    exit(1);
    310a:	4505                	li	a0,1
    ...
    3116:	5c650513          	addi	a0,a0,1478 # 66d8 <malloc+0x1524>
    311a:	7e3010ef          	jal	50fc <printf>
    exit(1);
    311e:	4505                	li	a0,1
    ...
    312a:	5e250513          	addi	a0,a0,1506 # 6708 <malloc+0x1554>
    312e:	7cf010ef          	jal	50fc <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    313e:	60650513          	addi	a0,a0,1542 # 6740 <malloc+0x158c>
    3142:	7bb010ef          	jal	50fc <printf>
    exit(1);
    3146:	4505                	li	a0,1
    ...
    3152:	61250513          	addi	a0,a0,1554 # 6760 <malloc+0x15ac>
    3156:	7a7010ef          	jal	50fc <printf>
    exit(1);
    315a:	4505                	li	a0,1
    ...
    3166:	62e50513          	addi	a0,a0,1582 # 6790 <malloc+0x15dc>
    316a:	793010ef          	jal	50fc <printf>
    exit(1);
    316e:	4505                	li	a0,1
    ...
    317a:	64250513          	addi	a0,a0,1602 # 67b8 <malloc+0x1604>
    317e:	77f010ef          	jal	50fc <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    318e:	64e50513          	addi	a0,a0,1614 # 67d8 <malloc+0x1624>
    3192:	76b010ef          	jal	50fc <printf>
    exit(1);
    3196:	4505                	li	a0,1
    ...
    31a2:	66250513          	addi	a0,a0,1634 # 6800 <malloc+0x164c>
    31a6:	757010ef          	jal	50fc <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31b6:	67650513          	addi	a0,a0,1654 # 6828 <malloc+0x1674>
    31ba:	743010ef          	jal	50fc <printf>
    exit(1);
    31be:	4505                	li	a0,1
    ...
    31ca:	69250513          	addi	a0,a0,1682 # 6858 <malloc+0x16a4>
    31ce:	72f010ef          	jal	50fc <printf>
    exit(1);
    31d2:	4505                	li	a0,1
    ...
    31de:	6ae50513          	addi	a0,a0,1710 # 6888 <malloc+0x16d4>
    31e2:	71b010ef          	jal	50fc <printf>
    exit(1);
    31e6:	4505                	li	a0,1
    ...
    31f2:	6b250513          	addi	a0,a0,1714 # 68a0 <malloc+0x16ec>
    31f6:	707010ef          	jal	50fc <printf>
    exit(1);
    31fa:	4505                	li	a0,1
    ...
    3206:	6be50513          	addi	a0,a0,1726 # 68c0 <malloc+0x170c>
    320a:	6f3010ef          	jal	50fc <printf>
    exit(1);
    320e:	4505                	li	a0,1
    ...
    321a:	6ca50513          	addi	a0,a0,1738 # 68e0 <malloc+0x172c>
    321e:	6df010ef          	jal	50fc <printf>
    exit(1);
    3222:	4505                	li	a0,1
    ...
    322e:	6f650513          	addi	a0,a0,1782 # 6920 <malloc+0x176c>
    3232:	6cb010ef          	jal	50fc <printf>
    exit(1);
    3236:	4505                	li	a0,1
    ...
    3242:	71250513          	addi	a0,a0,1810 # 6950 <malloc+0x179c>
    3246:	6b7010ef          	jal	50fc <printf>
    exit(1);
    324a:	4505                	li	a0,1
    ...
    3256:	71e50513          	addi	a0,a0,1822 # 6970 <malloc+0x17bc>
    325a:	6a3010ef          	jal	50fc <printf>
    exit(1);
    325e:	4505                	li	a0,1
    ...
    326a:	72a50513          	addi	a0,a0,1834 # 6990 <malloc+0x17dc>
    326e:	68f010ef          	jal	50fc <printf>
    exit(1);
    3272:	4505                	li	a0,1
    ...
    327e:	73650513          	addi	a0,a0,1846 # 69b0 <malloc+0x17fc>
    3282:	67b010ef          	jal	50fc <printf>
    exit(1);
    3286:	4505                	li	a0,1
    ...
    3292:	75250513          	addi	a0,a0,1874 # 69e0 <malloc+0x182c>
    3296:	667010ef          	jal	50fc <printf>
    exit(1);
    329a:	4505                	li	a0,1
    ...
    32a6:	76650513          	addi	a0,a0,1894 # 6a08 <malloc+0x1854>
    32aa:	653010ef          	jal	50fc <printf>
    exit(1);
    32ae:	4505                	li	a0,1
    ...
    32ba:	77a50513          	addi	a0,a0,1914 # 6a30 <malloc+0x187c>
    32be:	63f010ef          	jal	50fc <printf>
    exit(1);
    32c2:	4505                	li	a0,1
    ...
    32ce:	78e50513          	addi	a0,a0,1934 # 6a58 <malloc+0x18a4>
    32d2:	62b010ef          	jal	50fc <printf>
    exit(1);
    32d6:	4505                	li	a0,1
    ...
    32e2:	79a50513          	addi	a0,a0,1946 # 6a78 <malloc+0x18c4>
    32e6:	617010ef          	jal	50fc <printf>
    exit(1);
    32ea:	4505                	li	a0,1
    ...
    32f6:	7a650513          	addi	a0,a0,1958 # 6a98 <malloc+0x18e4>
    32fa:	603010ef          	jal	50fc <printf>
    exit(1);
    32fe:	4505                	li	a0,1
    ...
    330a:	7ba50513          	addi	a0,a0,1978 # 6ac0 <malloc+0x190c>
    330e:	5ef010ef          	jal	50fc <printf>
    exit(1);
    3312:	4505                	li	a0,1
    ...
    331e:	7c650513          	addi	a0,a0,1990 # 6ae0 <malloc+0x192c>
    3322:	5db010ef          	jal	50fc <printf>
    exit(1);
    3326:	4505                	li	a0,1
    ...
    3332:	7d250513          	addi	a0,a0,2002 # 6b00 <malloc+0x194c>
    3336:	5c7010ef          	jal	50fc <printf>
    exit(1);
    333a:	4505                	li	a0,1
    ...
    3346:	7e650513          	addi	a0,a0,2022 # 6b28 <malloc+0x1974>
    334a:	5b3010ef          	jal	50fc <printf>
    exit(1);
    334e:	4505                	li	a0,1
    ...
    335a:	46250513          	addi	a0,a0,1122 # 67b8 <malloc+0x1604>
    335e:	59f010ef          	jal	50fc <printf>
    exit(1);
    3362:	4505                	li	a0,1
    ...
    336e:	7de50513          	addi	a0,a0,2014 # 6b48 <malloc+0x1994>
    3372:	58b010ef          	jal	50fc <printf>
    exit(1);
    3376:	4505                	li	a0,1
    ...
    3382:	7ea50513          	addi	a0,a0,2026 # 6b68 <malloc+0x19b4>
    3386:	577010ef          	jal	50fc <printf>
    exit(1);
    338a:	4505                	li	a0,1
    ...
    3396:	80650513          	addi	a0,a0,-2042 # 6b98 <malloc+0x19e4>
    339a:	563010ef          	jal	50fc <printf>
    exit(1);
    339e:	4505                	li	a0,1
    ...
    33aa:	81250513          	addi	a0,a0,-2030 # 6bb8 <malloc+0x1a04>
    33ae:	54f010ef          	jal	50fc <printf>
    exit(1);
    33b2:	4505                	li	a0,1
...
00000000000033b8 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3444:	79850513          	addi	a0,a0,1944 # 6bd8 <malloc+0x1a24>
    3448:	4b5010ef          	jal	50fc <printf>
    exit(1);
    344c:	4505                	li	a0,1
    ...
    3458:	79c50513          	addi	a0,a0,1948 # 6bf0 <malloc+0x1a3c>
    345c:	4a1010ef          	jal	50fc <printf>
    exit(1);
    3460:	4505                	li	a0,1
    ...
    346c:	7a050513          	addi	a0,a0,1952 # 6c08 <malloc+0x1a54>
    3470:	48d010ef          	jal	50fc <printf>
    exit(1);
    3474:	4505                	li	a0,1
    ...
    3480:	7a450513          	addi	a0,a0,1956 # 6c20 <malloc+0x1a6c>
    3484:	479010ef          	jal	50fc <printf>
    exit(1);
    3488:	4505                	li	a0,1
    ...
    3494:	14050513          	addi	a0,a0,320 # 65d0 <malloc+0x141c>
    3498:	465010ef          	jal	50fc <printf>
    exit(1);
    349c:	4505                	li	a0,1
    ...
    34a8:	79c50513          	addi	a0,a0,1948 # 6c40 <malloc+0x1a8c>
    34ac:	451010ef          	jal	50fc <printf>
    exit(1);
    34b0:	4505                	li	a0,1
    ...
    34bc:	7b050513          	addi	a0,a0,1968 # 6c68 <malloc+0x1ab4>
    34c0:	43d010ef          	jal	50fc <printf>
    exit(1);
    34c4:	4505                	li	a0,1
    ...
    34d0:	7bc50513          	addi	a0,a0,1980 # 6c88 <malloc+0x1ad4>
    34d4:	429010ef          	jal	50fc <printf>
    exit(1);
    34d8:	4505                	li	a0,1
...
00000000000034de <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    34f4:	7b850513          	addi	a0,a0,1976 # 6ca8 <malloc+0x1af4>
  ...
  if(chdir("dirfile") == 0){
    ...
    3508:	7a450513          	addi	a0,a0,1956 # 6ca8 <malloc+0x1af4>
    350c:	057010ef          	jal	4d62 <chdir>
    3510:	c569                	beqz	a0,35da <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3512:	4581                	li	a1,0
    3514:	00003517          	auipc	a0,0x3
    3518:	7dc50513          	addi	a0,a0,2012 # 6cf0 <malloc+0x1b3c>
  ...
  fd = open(".", 0);
    ...
    3598:	43c50513          	addi	a0,a0,1084 # 59d0 <malloc+0x81c>
    359c:	796010ef          	jal	4d32 <open>
    35a0:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    35a2:	4605                	li	a2,1
    35a4:	00002597          	auipc	a1,0x2
    35a8:	db458593          	addi	a1,a1,-588 # 5358 <malloc+0x1a4>
  ...
  close(fd);
    ...
    35cc:	6e850513          	addi	a0,a0,1768 # 6cb0 <malloc+0x1afc>
    35d0:	32d010ef          	jal	50fc <printf>
    exit(1);
    35d4:	4505                	li	a0,1
    ...
    35e0:	6f450513          	addi	a0,a0,1780 # 6cd0 <malloc+0x1b1c>
    35e4:	319010ef          	jal	50fc <printf>
    exit(1);
    35e8:	4505                	li	a0,1
    ...
    35f4:	71050513          	addi	a0,a0,1808 # 6d00 <malloc+0x1b4c>
    35f8:	305010ef          	jal	50fc <printf>
    exit(1);
    35fc:	4505                	li	a0,1
    ...
    3608:	6fc50513          	addi	a0,a0,1788 # 6d00 <malloc+0x1b4c>
    360c:	2f1010ef          	jal	50fc <printf>
    exit(1);
    3610:	4505                	li	a0,1
    ...
    361c:	71050513          	addi	a0,a0,1808 # 6d28 <malloc+0x1b74>
    3620:	2dd010ef          	jal	50fc <printf>
    exit(1);
    3624:	4505                	li	a0,1
    ...
    3630:	72450513          	addi	a0,a0,1828 # 6d50 <malloc+0x1b9c>
    3634:	2c9010ef          	jal	50fc <printf>
    exit(1);
    3638:	4505                	li	a0,1
    ...
    3644:	73850513          	addi	a0,a0,1848 # 6d78 <malloc+0x1bc4>
    3648:	2b5010ef          	jal	50fc <printf>
    exit(1);
    364c:	4505                	li	a0,1
    ...
    3658:	74c50513          	addi	a0,a0,1868 # 6da0 <malloc+0x1bec>
    365c:	2a1010ef          	jal	50fc <printf>
    exit(1);
    3660:	4505                	li	a0,1
    ...
    366c:	75850513          	addi	a0,a0,1880 # 6dc0 <malloc+0x1c0c>
    3670:	28d010ef          	jal	50fc <printf>
    exit(1);
    3674:	4505                	li	a0,1
    ...
    3680:	76c50513          	addi	a0,a0,1900 # 6de8 <malloc+0x1c34>
    3684:	279010ef          	jal	50fc <printf>
    exit(1);
    3688:	4505                	li	a0,1
...
000000000000368e <iref>:
{
    ...
    36ae:	756a8a93          	addi	s5,s5,1878 # 6e00 <malloc+0x1c4c>
    mkdir("");
    36b2:	00003497          	auipc	s1,0x3
    36b6:	25648493          	addi	s1,s1,598 # 6908 <malloc+0x1754>
    link("README", "");
    36ba:	00002b17          	auipc	s6,0x2
    36be:	e06b0b13          	addi	s6,s6,-506 # 54c0 <malloc+0x30c>
    fd = open("", O_CREATE);
    36c2:	20000a13          	li	s4,512
    fd = open("xx", O_CREATE);
    36c6:	00003997          	auipc	s3,0x3
    36ca:	63298993          	addi	s3,s3,1586 # 6cf8 <malloc+0x1b44>
    36ce:	a835                	j	370a <iref+0x7c>
      printf("%s: mkdir irefd failed\n", s);
    36d0:	85de                	mv	a1,s7
    36d2:	00003517          	auipc	a0,0x3
    36d6:	73650513          	addi	a0,a0,1846 # 6e08 <malloc+0x1c54>
    36da:	223010ef          	jal	50fc <printf>
      exit(1);
    36de:	4505                	li	a0,1
    ...
    36ea:	73a50513          	addi	a0,a0,1850 # 6e20 <malloc+0x1c6c>
    36ee:	20f010ef          	jal	50fc <printf>
      exit(1);
    36f2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    374e:	ed698993          	addi	s3,s3,-298 # 6620 <malloc+0x146c>
    unlink("irefd");
    3752:	00003917          	auipc	s2,0x3
    3756:	6ae90913          	addi	s2,s2,1710 # 6e00 <malloc+0x1c4c>
    chdir("..");
    375a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    376e:	e5e50513          	addi	a0,a0,-418 # 65c8 <malloc+0x1414>
...
000000000000378c <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    379c:	6a050513          	addi	a0,a0,1696 # 6e38 <malloc+0x1c84>
  ...
  if(pid == 0){
    ...
    37b8:	68450513          	addi	a0,a0,1668 # 6e38 <malloc+0x1c84>
    ...
    37ca:	69250513          	addi	a0,a0,1682 # 6e58 <malloc+0x1ca4>
    37ce:	12f010ef          	jal	50fc <printf>
      exit(1);
    37d2:	4505                	li	a0,1
    ...
    37de:	66650513          	addi	a0,a0,1638 # 6e40 <malloc+0x1c8c>
    37e2:	11b010ef          	jal	50fc <printf>
    exit(1);
    37e6:	4505                	li	a0,1
    ...
    37f2:	38a50513          	addi	a0,a0,906 # 5b78 <malloc+0x9c4>
    37f6:	107010ef          	jal	50fc <printf>
    exit(1);
    37fa:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3810:	62c50513          	addi	a0,a0,1580 # 6e38 <malloc+0x1c84>
    3814:	52e010ef          	jal	4d42 <unlink>
    3818:	c919                	beqz	a0,382e <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    381a:	85a6                	mv	a1,s1
    381c:	00002517          	auipc	a0,0x2
    3820:	54c50513          	addi	a0,a0,1356 # 5d68 <malloc+0xbb4>
    3824:	0d9010ef          	jal	50fc <printf>
    exit(1);
    3828:	4505                	li	a0,1
...
000000000000383e <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    384e:	63650513          	addi	a0,a0,1590 # 6e80 <malloc+0x1ccc>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    386e:	61650513          	addi	a0,a0,1558 # 6e80 <malloc+0x1ccc>
  ...
  sleep(10); // one second
    ...
    3896:	4a650513          	addi	a0,a0,1190 # 5d38 <malloc+0xb84>
    389a:	063010ef          	jal	50fc <printf>
    exit(1);
    389e:	4505                	li	a0,1
    38a0:	452010ef          	jal	4cf2 <exit>
      int fd = open("stopforking", 0);
    38a4:	00003497          	auipc	s1,0x3
    38a8:	5dc48493          	addi	s1,s1,1500 # 6e80 <malloc+0x1ccc>
    38ac:	4581                	li	a1,0
    38ae:	8526                	mv	a0,s1
    ...
    38c8:	5bc50513          	addi	a0,a0,1468 # 6e80 <malloc+0x1ccc>
...
00000000000038dc <killstatus>:
{
  ...
  exit(0);
    ...
    3936:	24650513          	addi	a0,a0,582 # 5b78 <malloc+0x9c4>
    393a:	7c2010ef          	jal	50fc <printf>
      exit(1);
    393e:	4505                	li	a0,1
    ...
    3950:	54450513          	addi	a0,a0,1348 # 6e90 <malloc+0x1cdc>
    3954:	7a8010ef          	jal	50fc <printf>
       exit(1);
    3958:	4505                	li	a0,1
...
000000000000395e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3984:	3b850513          	addi	a0,a0,952 # 5d38 <malloc+0xb84>
    3988:	774010ef          	jal	50fc <printf>
    exit(1);
    398c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    39a6:	1d650513          	addi	a0,a0,470 # 5b78 <malloc+0x9c4>
    39aa:	752010ef          	jal	50fc <printf>
    exit(1);
    39ae:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    39d6:	98658593          	addi	a1,a1,-1658 # 5358 <malloc+0x1a4>
    ...
    39f8:	18450513          	addi	a0,a0,388 # 5b78 <malloc+0x9c4>
    39fc:	700010ef          	jal	50fc <printf>
     exit(1);
    3a00:	4505                	li	a0,1
    ...
    3a0c:	4a850513          	addi	a0,a0,1192 # 6eb0 <malloc+0x1cfc>
    3a10:	6ec010ef          	jal	50fc <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3a3c:	49050513          	addi	a0,a0,1168 # 6ec8 <malloc+0x1d14>
    3a40:	6bc010ef          	jal	50fc <printf>
}
  ...
  printf("kill... ");
    ...
    3a60:	48450513          	addi	a0,a0,1156 # 6ee0 <malloc+0x1d2c>
    3a64:	698010ef          	jal	50fc <printf>
  kill(pid1);
    3a68:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    3a7e:	47650513          	addi	a0,a0,1142 # 6ef0 <malloc+0x1d3c>
    3a82:	67a010ef          	jal	50fc <printf>
  wait(0);
    3a86:	4501                	li	a0,0
...
0000000000003a9a <reparent>:
{
  ...
  exit(0);
    ...
    3ade:	09e50513          	addi	a0,a0,158 # 5b78 <malloc+0x9c4>
    3ae2:	61a010ef          	jal	50fc <printf>
      exit(1);
    3ae6:	4505                	li	a0,1
    ...
    3af2:	21250513          	addi	a0,a0,530 # 5d00 <malloc+0xb4c>
    3af6:	606010ef          	jal	50fc <printf>
        exit(1);
    3afa:	4505                	li	a0,1
...
0000000000003b1a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3b56:	12e50513          	addi	a0,a0,302 # 5c80 <malloc+0xacc>
    3b5a:	5a2010ef          	jal	50fc <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b7a:	7e258593          	addi	a1,a1,2018 # 5358 <malloc+0x1a4>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3c1e:	2e650513          	addi	a0,a0,742 # 6f00 <malloc+0x1d4c>
    3c22:	4da010ef          	jal	50fc <printf>
    exit(1);
    3c26:	4505                	li	a0,1
    ...
    3c32:	f4a50513          	addi	a0,a0,-182 # 5b78 <malloc+0x9c4>
    3c36:	4c6010ef          	jal	50fc <printf>
    exit(1);
    3c3a:	4505                	li	a0,1
    ...
    3c6e:	2b650513          	addi	a0,a0,694 # 6f20 <malloc+0x1d6c>
    3c72:	48a010ef          	jal	50fc <printf>
    exit(1);
    3c76:	4505                	li	a0,1
...
0000000000003c82 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3cc6:	6084                	ld	s1,0(s1)
      free(m1);
    3cc8:	466010ef          	jal	512e <free>
    while(m1){
    3ccc:	fce5                	bnez	s1,3cc4 <mem+0x42>
    m1 = malloc(1024*20);
    3cce:	6515                	lui	a0,0x5
    3cd0:	4e4010ef          	jal	51b4 <malloc>
    if(m1 == 0){
    3cd4:	c511                	beqz	a0,3ce0 <mem+0x5e>
    free(m1);
    3cd6:	458010ef          	jal	512e <free>
    exit(0);
    3cda:	4501                	li	a0,0
    ...
    3ce6:	26e50513          	addi	a0,a0,622 # 6f50 <malloc+0x1d9c>
    3cea:	412010ef          	jal	50fc <printf>
      exit(1);
    3cee:	4505                	li	a0,1
...
0000000000003cfa <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3d0a:	26a50513          	addi	a0,a0,618 # 6f70 <malloc+0x1dbc>
    3d0e:	034010ef          	jal	4d42 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3d12:	20200593          	li	a1,514
    3d16:	00003517          	auipc	a0,0x3
    3d1a:	25a50513          	addi	a0,a0,602 # 6f70 <malloc+0x1dbc>
  ...
  if(pid == 0) {
    ...
    3d8e:	1f650513          	addi	a0,a0,502 # 6f80 <malloc+0x1dcc>
    3d92:	36a010ef          	jal	50fc <printf>
    exit(1);
    3d96:	4505                	li	a0,1
    ...
    3da8:	20450513          	addi	a0,a0,516 # 6fa8 <malloc+0x1df4>
    3dac:	350010ef          	jal	50fc <printf>
      exit(1);
    3db0:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3de0:	19450513          	addi	a0,a0,404 # 6f70 <malloc+0x1dbc>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3e24:	1a850513          	addi	a0,a0,424 # 6fc8 <malloc+0x1e14>
    3e28:	2d4010ef          	jal	50fc <printf>
    exit(1);
    3e2c:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3e54:	12050513          	addi	a0,a0,288 # 6f70 <malloc+0x1dbc>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3e76:	17e50513          	addi	a0,a0,382 # 6ff0 <malloc+0x1e3c>
    3e7a:	282010ef          	jal	50fc <printf>
    exit(1);
    3e7e:	4505                	li	a0,1
...
0000000000003e8a <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3eae:	15e78793          	addi	a5,a5,350 # 7008 <malloc+0x1e54>
    3eb2:	f6f43823          	sd	a5,-144(s0)
    3eb6:	00003797          	auipc	a5,0x3
    3eba:	15a78793          	addi	a5,a5,346 # 7010 <malloc+0x1e5c>
    3ebe:	f6f43c23          	sd	a5,-136(s0)
    3ec2:	00003797          	auipc	a5,0x3
    3ec6:	15678793          	addi	a5,a5,342 # 7018 <malloc+0x1e64>
    3eca:	f8f43023          	sd	a5,-128(s0)
    3ece:	00003797          	auipc	a5,0x3
    3ed2:	15278793          	addi	a5,a5,338 # 7020 <malloc+0x1e6c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3f38:	c4450513          	addi	a0,a0,-956 # 5b78 <malloc+0x9c4>
    3f3c:	1c0010ef          	jal	50fc <printf>
      exit(1);
    3f40:	4505                	li	a0,1
    ...
    3f98:	c7c50513          	addi	a0,a0,-900 # 5c10 <malloc+0xa5c>
    3f9c:	160010ef          	jal	50fc <printf>
        exit(1);
    3fa0:	4505                	li	a0,1
    3fa2:	551000ef          	jal	4cf2 <exit>
          printf("write failed %d\n", n);
    3fa6:	00003517          	auipc	a0,0x3
    3faa:	08250513          	addi	a0,a0,130 # 7028 <malloc+0x1e74>
    3fae:	14e010ef          	jal	50fc <printf>
          exit(1);
    3fb2:	4505                	li	a0,1
    ...
    3fc4:	08050513          	addi	a0,a0,128 # 7040 <malloc+0x1e8c>
    3fc8:	134010ef          	jal	50fc <printf>
          exit(1);
    3fcc:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    402e:	02650513          	addi	a0,a0,38 # 7050 <malloc+0x1e9c>
    4032:	0ca010ef          	jal	50fc <printf>
      exit(1);
    4036:	4505                	li	a0,1
...
000000000000405a <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    409c:	fd0d0d13          	addi	s10,s10,-48 # 7068 <malloc+0x1eb4>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    40f0:	f8450513          	addi	a0,a0,-124 # 7070 <malloc+0x1ebc>
    40f4:	008010ef          	jal	50fc <printf>
        exit(1);
    40f8:	4505                	li	a0,1
    ...
    4106:	f6650513          	addi	a0,a0,-154 # 7068 <malloc+0x1eb4>
  ...
  fd = open(".", 0);
    ...
    412e:	8a650513          	addi	a0,a0,-1882 # 59d0 <malloc+0x81c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    419c:	ef850513          	addi	a0,a0,-264 # 7090 <malloc+0x1edc>
    41a0:	75d000ef          	jal	50fc <printf>
        exit(1);
    41a4:	4505                	li	a0,1
    ...
    41b4:	f0050513          	addi	a0,a0,-256 # 70b0 <malloc+0x1efc>
    41b8:	745000ef          	jal	50fc <printf>
        exit(1);
    41bc:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    41e8:	ef450513          	addi	a0,a0,-268 # 70d8 <malloc+0x1f24>
    41ec:	711000ef          	jal	50fc <printf>
    exit(1);
    41f0:	4505                	li	a0,1
    ...
    41fc:	98050513          	addi	a0,a0,-1664 # 5b78 <malloc+0x9c4>
    4200:	6fd000ef          	jal	50fc <printf>
      exit(1);
    4204:	4505                	li	a0,1
...
000000000000433c <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4356:	dbe50513          	addi	a0,a0,-578 # 7110 <malloc+0x1f5c>
    435a:	1e9000ef          	jal	4d42 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    435e:	20200593          	li	a1,514
    4362:	00003517          	auipc	a0,0x3
    4366:	dae50513          	addi	a0,a0,-594 # 7110 <malloc+0x1f5c>
  ...
  fd = open("bigfile.dat", 0);
    ...
    43ae:	d6650513          	addi	a0,a0,-666 # 7110 <malloc+0x1f5c>
  ...
  for(i = 0; ; i++){
    ...
    4408:	d1c50513          	addi	a0,a0,-740 # 7120 <malloc+0x1f6c>
    440c:	4f1000ef          	jal	50fc <printf>
    exit(1);
    4410:	4505                	li	a0,1
    ...
    441c:	d2850513          	addi	a0,a0,-728 # 7140 <malloc+0x1f8c>
    4420:	4dd000ef          	jal	50fc <printf>
      exit(1);
    4424:	4505                	li	a0,1
    ...
    4430:	d3450513          	addi	a0,a0,-716 # 7160 <malloc+0x1fac>
    4434:	4c9000ef          	jal	50fc <printf>
    exit(1);
    4438:	4505                	li	a0,1
    ...
    4444:	d4050513          	addi	a0,a0,-704 # 7180 <malloc+0x1fcc>
    4448:	4b5000ef          	jal	50fc <printf>
      exit(1);
    444c:	4505                	li	a0,1
    ...
    4458:	d4c50513          	addi	a0,a0,-692 # 71a0 <malloc+0x1fec>
    445c:	4a1000ef          	jal	50fc <printf>
      exit(1);
    4460:	4505                	li	a0,1
    ...
    446c:	d5050513          	addi	a0,a0,-688 # 71b8 <malloc+0x2004>
    4470:	48d000ef          	jal	50fc <printf>
      exit(1);
    4474:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    448e:	c8650513          	addi	a0,a0,-890 # 7110 <malloc+0x1f5c>
    ...
    44b0:	d2c50513          	addi	a0,a0,-724 # 71d8 <malloc+0x2024>
    44b4:	449000ef          	jal	50fc <printf>
    exit(1);
    44b8:	4505                	li	a0,1
...
00000000000044be <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    44e0:	d1c50513          	addi	a0,a0,-740 # 71f8 <malloc+0x2044>
    44e4:	419000ef          	jal	50fc <printf>
  for(nfiles = 0; ; nfiles++){
    44e8:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4596:	c7650513          	addi	a0,a0,-906 # 7208 <malloc+0x2054>
    459a:	363000ef          	jal	50fc <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    45b6:	c6650513          	addi	a0,a0,-922 # 7218 <malloc+0x2064>
    45ba:	343000ef          	jal	50fc <printf>
    name[0] = 'f';
  ...
  printf("fsfull test finished\n");
    ...
    4674:	bc850513          	addi	a0,a0,-1080 # 7238 <malloc+0x2084>
    4678:	285000ef          	jal	50fc <printf>
}
    ...
    46c6:	b6650513          	addi	a0,a0,-1178 # 7228 <malloc+0x2074>
    46ca:	233000ef          	jal	50fc <printf>
    close(fd);
    46ce:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    46f0:	b6450513          	addi	a0,a0,-1180 # 7250 <malloc+0x209c>
    46f4:	209000ef          	jal	50fc <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4714:	b6850513          	addi	a0,a0,-1176 # 7278 <malloc+0x20c4>
    4718:	1e5000ef          	jal	50fc <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4734:	b3050513          	addi	a0,a0,-1232 # 7260 <malloc+0x20ac>
    4738:	1c5000ef          	jal	50fc <printf>
    exit(1);
    473c:	4505                	li	a0,1
    ...
    4750:	b3450513          	addi	a0,a0,-1228 # 7280 <malloc+0x20cc>
    4754:	1a9000ef          	jal	50fc <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    47a8:	ae450513          	addi	a0,a0,-1308 # 7288 <malloc+0x20d4>
    47ac:	151000ef          	jal	50fc <printf>
          return 1;
    47b0:	4505                	li	a0,1
...
countfree()
{
  ...
  if(pid == 0){
    ...
    480c:	b50a0a13          	addi	s4,s4,-1200 # 5358 <malloc+0x1a4>
      uint64 a = (uint64) sbrk(4096);
    4810:	854a                	mv	a0,s2
    ...
    4834:	ab050513          	addi	a0,a0,-1360 # 72e0 <malloc+0x212c>
    4838:	0c5000ef          	jal	50fc <printf>
        exit(1);
    483c:	4505                	li	a0,1
    ...
    484e:	a5650513          	addi	a0,a0,-1450 # 72a0 <malloc+0x20ec>
    4852:	0ab000ef          	jal	50fc <printf>
    exit(1);
    4856:	4505                	li	a0,1
    ...
    4868:	a5c50513          	addi	a0,a0,-1444 # 72c0 <malloc+0x210c>
    486c:	091000ef          	jal	50fc <printf>
    exit(1);
    4870:	4505                	li	a0,1
  ...
  while(1){
    ...
    48ae:	a5650513          	addi	a0,a0,-1450 # 7300 <malloc+0x214c>
    48b2:	04b000ef          	jal	50fc <printf>
      exit(1);
    48b6:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    4900:	a24b8b93          	addi	s7,s7,-1500 # 7320 <malloc+0x216c>
    int free0 = countfree();
    int free1 = 0;
    ...
    491a:	a22d0d13          	addi	s10,s10,-1502 # 7338 <malloc+0x2184>
          return 1;
        }
      }
    }
    ...
    4922:	a3ac8c93          	addi	s9,s9,-1478 # 7358 <malloc+0x21a4>
    4926:	a819                	j	493c <drivetests+0x62>
        printf("usertests slow tests starting\n");
    4928:	856a                	mv	a0,s10
    492a:	7d2000ef          	jal	50fc <printf>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    49de:	9ae58593          	addi	a1,a1,-1618 # 7388 <malloc+0x21d4>
    49e2:	854a                	mv	a0,s2
    ...
    49f0:	9a458593          	addi	a1,a1,-1628 # 7390 <malloc+0x21dc>
    49f4:	854a                	mv	a0,s2
    49f6:	090000ef          	jal	4a86 <strcmp>
    49fa:	cd15                	beqz	a0,4a36 <main+0x8e>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    49fc:	00003597          	auipc	a1,0x3
    4a00:	99c58593          	addi	a1,a1,-1636 # 7398 <malloc+0x21e4>
    4a04:	854a                	mv	a0,s2
  ...
  int continuous = 0;
    ...
    4a22:	98250513          	addi	a0,a0,-1662 # 73a0 <malloc+0x21ec>
    4a26:	6d6000ef          	jal	50fc <printf>
    exit(1);
    4a2a:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4a46:	98e50513          	addi	a0,a0,-1650 # 73d0 <malloc+0x221c>
    4a4a:	6b2000ef          	jal	50fc <printf>
  exit(0);
    4a4e:	4501                	li	a0,0
...
putc(int fd, char c)
{
    4d9a:	1101                	addi	sp,sp,-32
    4d9c:	ec06                	sd	ra,24(sp)
    4d9e:	e822                	sd	s0,16(sp)
    4da0:	1000                	addi	s0,sp,32
    4da2:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4da6:	4605                	li	a2,1
    4da8:	fef40593          	addi	a1,s0,-17
    4dac:	f67ff0ef          	jal	4d12 <write>
}
    4db0:	60e2                	ld	ra,24(sp)
    4db2:	6442                	ld	s0,16(sp)
    4db4:	6105                	addi	sp,sp,32
    4db6:	8082                	ret

0000000000004db8 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    4db8:	7139                	addi	sp,sp,-64
    4dba:	fc06                	sd	ra,56(sp)
    4dbc:	f822                	sd	s0,48(sp)
    4dbe:	f426                	sd	s1,40(sp)
    4dc0:	f04a                	sd	s2,32(sp)
    4dc2:	ec4e                	sd	s3,24(sp)
    4dc4:	0080                	addi	s0,sp,64
    4dc6:	892a                	mv	s2,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4dc8:	c299                	beqz	a3,4dce <printint+0x16>
    4dca:	0605ce63          	bltz	a1,4e46 <printint+0x8e>
  neg = 0;
    4dce:	4e01                	li	t3,0
    x = -xx;
  } else {
  ...
  do{
    buf[i++] = digits[x % base];
    4dd8:	00003817          	auipc	a6,0x3
    4ddc:	9c880813          	addi	a6,a6,-1592 # 77a0 <digits>
    4de0:	88be                	mv	a7,a5
    4de2:	0017851b          	addiw	a0,a5,1
    4de6:	87aa                	mv	a5,a0
    4de8:	02c5f73b          	remuw	a4,a1,a2
    4dec:	1702                	slli	a4,a4,0x20
    4dee:	9301                	srli	a4,a4,0x20
    4df0:	9742                	add	a4,a4,a6
    4df2:	00074703          	lbu	a4,0(a4)
    4df6:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    4dfa:	872e                	mv	a4,a1
    4dfc:	02c5d5bb          	divuw	a1,a1,a2
    4e00:	0685                	addi	a3,a3,1
    4e02:	fcc77fe3          	bgeu	a4,a2,4de0 <printint+0x28>
  if(neg)
    4e06:	000e0c63          	beqz	t3,4e1e <printint+0x66>
    buf[i++] = '-';
    4e0a:	fd050793          	addi	a5,a0,-48
    4e0e:	00878533          	add	a0,a5,s0
    4e12:	02d00793          	li	a5,45
    4e16:	fef50823          	sb	a5,-16(a0)
    4e1a:	0028879b          	addiw	a5,a7,2

  while(--i >= 0)
    4e1e:	fff7899b          	addiw	s3,a5,-1
    4e22:	006784b3          	add	s1,a5,t1
    putc(fd, buf[i]);
    4e26:	fff4c583          	lbu	a1,-1(s1)
    4e2a:	854a                	mv	a0,s2
    4e2c:	f6fff0ef          	jal	4d9a <putc>
  while(--i >= 0)
    4e30:	39fd                	addiw	s3,s3,-1
    4e32:	14fd                	addi	s1,s1,-1
    4e34:	fe09d9e3          	bgez	s3,4e26 <printint+0x6e>
}
    4e38:	70e2                	ld	ra,56(sp)
    4e3a:	7442                	ld	s0,48(sp)
    4e3c:	74a2                	ld	s1,40(sp)
    4e3e:	7902                	ld	s2,32(sp)
    4e40:	69e2                	ld	s3,24(sp)
    4e42:	6121                	addi	sp,sp,64
    4e44:	8082                	ret
    x = -xx;
    4e46:	40b005bb          	negw	a1,a1
    neg = 1;
    4e4a:	4e05                	li	t3,1
    x = -xx;
    4e4c:	b751                	j	4dd0 <printint+0x18>

0000000000004e4e <vprintf>:
}
...
{
    4e4e:	711d                	addi	sp,sp,-96
    4e50:	ec86                	sd	ra,88(sp)
    4e52:	e8a2                	sd	s0,80(sp)
    4e54:	e4a6                	sd	s1,72(sp)
    4e56:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4e58:	0005c483          	lbu	s1,0(a1)
    4e5c:	26048663          	beqz	s1,50c8 <vprintf+0x27a>
    4e60:	e0ca                	sd	s2,64(sp)
    4e62:	fc4e                	sd	s3,56(sp)
    4e64:	f852                	sd	s4,48(sp)
    4e66:	f456                	sd	s5,40(sp)
    4e68:	f05a                	sd	s6,32(sp)
    4e6a:	ec5e                	sd	s7,24(sp)
    4e6c:	e862                	sd	s8,16(sp)
    4e6e:	e466                	sd	s9,8(sp)
    4e70:	8b2a                	mv	s6,a0
    4e72:	8a2e                	mv	s4,a1
    4e74:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4e7c:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4e80:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4e84:	06c00c93          	li	s9,108
    4e88:	a00d                	j	4eaa <vprintf+0x5c>
        putc(fd, c0);
    4e8a:	85a6                	mv	a1,s1
    4e8c:	855a                	mv	a0,s6
    4e8e:	f0dff0ef          	jal	4d9a <putc>
    4e92:	a019                	j	4e98 <vprintf+0x4a>
    } else if(state == '%'){
    4e94:	03598363          	beq	s3,s5,4eba <vprintf+0x6c>
  for(i = 0; fmt[i]; i++){
    4e98:	0019079b          	addiw	a5,s2,1
    4e9c:	893e                	mv	s2,a5
    4e9e:	873e                	mv	a4,a5
    4ea0:	97d2                	add	a5,a5,s4
    4ea2:	0007c483          	lbu	s1,0(a5)
    4ea6:	20048963          	beqz	s1,50b8 <vprintf+0x26a>
    c0 = fmt[i] & 0xff;
    4eaa:	0004879b          	sext.w	a5,s1
    if(state == 0){
    4eae:	fe0993e3          	bnez	s3,4e94 <vprintf+0x46>
      if(c0 == '%'){
    4eb2:	fd579ce3          	bne	a5,s5,4e8a <vprintf+0x3c>
        state = '%';
    4eb6:	89be                	mv	s3,a5
    4eb8:	b7c5                	j	4e98 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4eba:	00ea06b3          	add	a3,s4,a4
    4ebe:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4ec2:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4ec4:	c681                	beqz	a3,4ecc <vprintf+0x7e>
    4ec6:	9752                	add	a4,a4,s4
    4ec8:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4ecc:	03878e63          	beq	a5,s8,4f08 <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
    4ed0:	05978863          	beq	a5,s9,4f20 <vprintf+0xd2>
    ...
    4ed4:	07500713          	li	a4,117
    4ed8:	0ee78263          	beq	a5,a4,4fbc <vprintf+0x16e>
    ...
    4edc:	07800713          	li	a4,120
    4ee0:	12e78463          	beq	a5,a4,5008 <vprintf+0x1ba>
    ...
    4ee4:	07000713          	li	a4,112
    4ee8:	14e78963          	beq	a5,a4,503a <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
    4eec:	07300713          	li	a4,115
    4ef0:	18e78863          	beq	a5,a4,5080 <vprintf+0x232>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4ef4:	02500713          	li	a4,37
    4ef8:	04e79463          	bne	a5,a4,4f40 <vprintf+0xf2>
        putc(fd, '%');
    4efc:	85ba                	mv	a1,a4
    4efe:	855a                	mv	a0,s6
    4f00:	e9bff0ef          	jal	4d9a <putc>
      ...
      state = 0;
    4f04:	4981                	li	s3,0
    4f06:	bf49                	j	4e98 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4f08:	008b8493          	addi	s1,s7,8
    4f0c:	4685                	li	a3,1
    4f0e:	4629                	li	a2,10
    4f10:	000ba583          	lw	a1,0(s7)
    4f14:	855a                	mv	a0,s6
    4f16:	ea3ff0ef          	jal	4db8 <printint>
    4f1a:	8ba6                	mv	s7,s1
      state = 0;
    4f1c:	4981                	li	s3,0
    4f1e:	bfad                	j	4e98 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4f20:	06400793          	li	a5,100
    4f24:	02f68963          	beq	a3,a5,4f56 <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4f28:	06c00793          	li	a5,108
    4f2c:	04f68263          	beq	a3,a5,4f70 <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
    4f30:	07500793          	li	a5,117
    4f34:	0af68063          	beq	a3,a5,4fd4 <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
    4f38:	07800793          	li	a5,120
    4f3c:	0ef68263          	beq	a3,a5,5020 <vprintf+0x1d2>
        putc(fd, '%');
    4f40:	02500593          	li	a1,37
    4f44:	855a                	mv	a0,s6
    4f46:	e55ff0ef          	jal	4d9a <putc>
        putc(fd, c0);
    4f4a:	85a6                	mv	a1,s1
    4f4c:	855a                	mv	a0,s6
    4f4e:	e4dff0ef          	jal	4d9a <putc>
      state = 0;
    4f52:	4981                	li	s3,0
    4f54:	b791                	j	4e98 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f56:	008b8493          	addi	s1,s7,8
    4f5a:	4685                	li	a3,1
    4f5c:	4629                	li	a2,10
    4f5e:	000ba583          	lw	a1,0(s7)
    4f62:	855a                	mv	a0,s6
    4f64:	e55ff0ef          	jal	4db8 <printint>
        i += 1;
    4f68:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f6a:	8ba6                	mv	s7,s1
      state = 0;
    4f6c:	4981                	li	s3,0
        i += 1;
    4f6e:	b72d                	j	4e98 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4f70:	06400793          	li	a5,100
    4f74:	02f60763          	beq	a2,a5,4fa2 <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4f78:	07500793          	li	a5,117
    4f7c:	06f60963          	beq	a2,a5,4fee <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4f80:	07800793          	li	a5,120
    4f84:	faf61ee3          	bne	a2,a5,4f40 <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4f88:	008b8493          	addi	s1,s7,8
    4f8c:	4681                	li	a3,0
    4f8e:	4641                	li	a2,16
    4f90:	000ba583          	lw	a1,0(s7)
    4f94:	855a                	mv	a0,s6
    4f96:	e23ff0ef          	jal	4db8 <printint>
        i += 2;
    4f9a:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    4f9c:	8ba6                	mv	s7,s1
      state = 0;
    4f9e:	4981                	li	s3,0
        i += 2;
    4fa0:	bde5                	j	4e98 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4fa2:	008b8493          	addi	s1,s7,8
    4fa6:	4685                	li	a3,1
    4fa8:	4629                	li	a2,10
    4faa:	000ba583          	lw	a1,0(s7)
    4fae:	855a                	mv	a0,s6
    4fb0:	e09ff0ef          	jal	4db8 <printint>
        i += 2;
    4fb4:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    4fb6:	8ba6                	mv	s7,s1
      state = 0;
    4fb8:	4981                	li	s3,0
        i += 2;
    4fba:	bdf9                	j	4e98 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 0);
    4fbc:	008b8493          	addi	s1,s7,8
    4fc0:	4681                	li	a3,0
    4fc2:	4629                	li	a2,10
    4fc4:	000ba583          	lw	a1,0(s7)
    4fc8:	855a                	mv	a0,s6
    4fca:	defff0ef          	jal	4db8 <printint>
    4fce:	8ba6                	mv	s7,s1
      state = 0;
    4fd0:	4981                	li	s3,0
    4fd2:	b5d9                	j	4e98 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4fd4:	008b8493          	addi	s1,s7,8
    4fd8:	4681                	li	a3,0
    4fda:	4629                	li	a2,10
    4fdc:	000ba583          	lw	a1,0(s7)
    4fe0:	855a                	mv	a0,s6
    4fe2:	dd7ff0ef          	jal	4db8 <printint>
        i += 1;
    4fe6:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    4fe8:	8ba6                	mv	s7,s1
      state = 0;
    4fea:	4981                	li	s3,0
        i += 1;
    4fec:	b575                	j	4e98 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4fee:	008b8493          	addi	s1,s7,8
    4ff2:	4681                	li	a3,0
    4ff4:	4629                	li	a2,10
    4ff6:	000ba583          	lw	a1,0(s7)
    4ffa:	855a                	mv	a0,s6
    4ffc:	dbdff0ef          	jal	4db8 <printint>
        i += 2;
    5000:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    5002:	8ba6                	mv	s7,s1
      state = 0;
    5004:	4981                	li	s3,0
        i += 2;
    5006:	bd49                	j	4e98 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 16, 0);
    5008:	008b8493          	addi	s1,s7,8
    500c:	4681                	li	a3,0
    500e:	4641                	li	a2,16
    5010:	000ba583          	lw	a1,0(s7)
    5014:	855a                	mv	a0,s6
    5016:	da3ff0ef          	jal	4db8 <printint>
    501a:	8ba6                	mv	s7,s1
      state = 0;
    501c:	4981                	li	s3,0
    501e:	bdad                	j	4e98 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    5020:	008b8493          	addi	s1,s7,8
    5024:	4681                	li	a3,0
    5026:	4641                	li	a2,16
    5028:	000ba583          	lw	a1,0(s7)
    502c:	855a                	mv	a0,s6
    502e:	d8bff0ef          	jal	4db8 <printint>
        i += 1;
    5032:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    5034:	8ba6                	mv	s7,s1
      state = 0;
    5036:	4981                	li	s3,0
        i += 1;
    5038:	b585                	j	4e98 <vprintf+0x4a>
    503a:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    503c:	008b8d13          	addi	s10,s7,8
    5040:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5044:	03000593          	li	a1,48
    5048:	855a                	mv	a0,s6
    504a:	d51ff0ef          	jal	4d9a <putc>
  putc(fd, 'x');
    504e:	07800593          	li	a1,120
    5052:	855a                	mv	a0,s6
    5054:	d47ff0ef          	jal	4d9a <putc>
    5058:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    505a:	00002b97          	auipc	s7,0x2
    505e:	746b8b93          	addi	s7,s7,1862 # 77a0 <digits>
    5062:	03c9d793          	srli	a5,s3,0x3c
    5066:	97de                	add	a5,a5,s7
    5068:	0007c583          	lbu	a1,0(a5)
    506c:	855a                	mv	a0,s6
    506e:	d2dff0ef          	jal	4d9a <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5072:	0992                	slli	s3,s3,0x4
    5074:	34fd                	addiw	s1,s1,-1
    5076:	f4f5                	bnez	s1,5062 <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
    5078:	8bea                	mv	s7,s10
      state = 0;
    507a:	4981                	li	s3,0
    507c:	6d02                	ld	s10,0(sp)
    507e:	bd29                	j	4e98 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    5080:	008b8993          	addi	s3,s7,8
    5084:	000bb483          	ld	s1,0(s7)
    5088:	cc91                	beqz	s1,50a4 <vprintf+0x256>
        for(; *s; s++)
    508a:	0004c583          	lbu	a1,0(s1)
    508e:	c195                	beqz	a1,50b2 <vprintf+0x264>
          putc(fd, *s);
    5090:	855a                	mv	a0,s6
    5092:	d09ff0ef          	jal	4d9a <putc>
        for(; *s; s++)
    5096:	0485                	addi	s1,s1,1
    5098:	0004c583          	lbu	a1,0(s1)
    509c:	f9f5                	bnez	a1,5090 <vprintf+0x242>
        if((s = va_arg(ap, char*)) == 0)
    509e:	8bce                	mv	s7,s3
      state = 0;
    50a0:	4981                	li	s3,0
    50a2:	bbdd                	j	4e98 <vprintf+0x4a>
          s = "(null)";
    50a4:	00002497          	auipc	s1,0x2
    50a8:	67c48493          	addi	s1,s1,1660 # 7720 <malloc+0x256c>
        for(; *s; s++)
    50ac:	02800593          	li	a1,40
    50b0:	b7c5                	j	5090 <vprintf+0x242>
        if((s = va_arg(ap, char*)) == 0)
    50b2:	8bce                	mv	s7,s3
      state = 0;
    50b4:	4981                	li	s3,0
    50b6:	b3cd                	j	4e98 <vprintf+0x4a>
    50b8:	6906                	ld	s2,64(sp)
    50ba:	79e2                	ld	s3,56(sp)
    50bc:	7a42                	ld	s4,48(sp)
    50be:	7aa2                	ld	s5,40(sp)
    50c0:	7b02                	ld	s6,32(sp)
    50c2:	6be2                	ld	s7,24(sp)
    50c4:	6c42                	ld	s8,16(sp)
    50c6:	6ca2                	ld	s9,8(sp)
    }
  }
}
    50c8:	60e6                	ld	ra,88(sp)
    50ca:	6446                	ld	s0,80(sp)
    50cc:	64a6                	ld	s1,72(sp)
    50ce:	6125                	addi	sp,sp,96
    50d0:	8082                	ret

00000000000050d2 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    50d2:	715d                	addi	sp,sp,-80
    50d4:	ec06                	sd	ra,24(sp)
    50d6:	e822                	sd	s0,16(sp)
    50d8:	1000                	addi	s0,sp,32
    50da:	e010                	sd	a2,0(s0)
    50dc:	e414                	sd	a3,8(s0)
    50de:	e818                	sd	a4,16(s0)
    50e0:	ec1c                	sd	a5,24(s0)
    50e2:	03043023          	sd	a6,32(s0)
    50e6:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    50ea:	8622                	mv	a2,s0
    50ec:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    50f0:	d5fff0ef          	jal	4e4e <vprintf>
}
    50f4:	60e2                	ld	ra,24(sp)
    50f6:	6442                	ld	s0,16(sp)
    50f8:	6161                	addi	sp,sp,80
    50fa:	8082                	ret

00000000000050fc <printf>:

void
printf(const char *fmt, ...)
{
    50fc:	711d                	addi	sp,sp,-96
    50fe:	ec06                	sd	ra,24(sp)
    5100:	e822                	sd	s0,16(sp)
    5102:	1000                	addi	s0,sp,32
    5104:	e40c                	sd	a1,8(s0)
    5106:	e810                	sd	a2,16(s0)
    5108:	ec14                	sd	a3,24(s0)
    510a:	f018                	sd	a4,32(s0)
    510c:	f41c                	sd	a5,40(s0)
    510e:	03043823          	sd	a6,48(s0)
    5112:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5116:	00840613          	addi	a2,s0,8
    511a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    511e:	85aa                	mv	a1,a0
    5120:	4505                	li	a0,1
    5122:	d2dff0ef          	jal	4e4e <vprintf>
}
    5126:	60e2                	ld	ra,24(sp)
    5128:	6442                	ld	s0,16(sp)
    512a:	6125                	addi	sp,sp,96
    512c:	8082                	ret

000000000000512e <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    5130:	e406                	sd	ra,8(sp)
    5132:	e022                	sd	s0,0(sp)
    5134:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5136:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    513a:	00004797          	auipc	a5,0x4
    513e:	3167b783          	ld	a5,790(a5) # 9450 <freep>
    5142:	a02d                	j	516c <free+0x3e>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5144:	4618                	lw	a4,8(a2)
    5146:	9f2d                	addw	a4,a4,a1
    5148:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    514c:	6398                	ld	a4,0(a5)
    514e:	6310                	ld	a2,0(a4)
    5150:	a83d                	j	518e <free+0x60>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5152:	ff852703          	lw	a4,-8(a0)
    5156:	9f31                	addw	a4,a4,a2
    5158:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    515a:	ff053683          	ld	a3,-16(a0)
    515e:	a091                	j	51a2 <free+0x74>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5160:	6398                	ld	a4,0(a5)
    5162:	00e7e463          	bltu	a5,a4,516a <free+0x3c>
    5166:	00e6ea63          	bltu	a3,a4,517a <free+0x4c>
{
    516a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    516c:	fed7fae3          	bgeu	a5,a3,5160 <free+0x32>
    5170:	6398                	ld	a4,0(a5)
    5172:	00e6e463          	bltu	a3,a4,517a <free+0x4c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5176:	fee7eae3          	bltu	a5,a4,516a <free+0x3c>
  if(bp + bp->s.size == p->s.ptr){
    517a:	ff852583          	lw	a1,-8(a0)
    517e:	6390                	ld	a2,0(a5)
    5180:	02059813          	slli	a6,a1,0x20
    5184:	01c85713          	srli	a4,a6,0x1c
    5188:	9736                	add	a4,a4,a3
    518a:	fae60de3          	beq	a2,a4,5144 <free+0x16>
    bp->s.ptr = p->s.ptr->s.ptr;
    518e:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5192:	4790                	lw	a2,8(a5)
    5194:	02061593          	slli	a1,a2,0x20
    5198:	01c5d713          	srli	a4,a1,0x1c
    519c:	973e                	add	a4,a4,a5
    519e:	fae68ae3          	beq	a3,a4,5152 <free+0x24>
    p->s.ptr = bp->s.ptr;
    51a2:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    51a4:	00004717          	auipc	a4,0x4
    51a8:	2af73623          	sd	a5,684(a4) # 9450 <freep>
}
    51ac:	60a2                	ld	ra,8(sp)
    51ae:	6402                	ld	s0,0(sp)
    51b0:	0141                	addi	sp,sp,16
    51b2:	8082                	ret

00000000000051b4 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    51b4:	7139                	addi	sp,sp,-64
    51b6:	fc06                	sd	ra,56(sp)
    51b8:	f822                	sd	s0,48(sp)
    51ba:	f04a                	sd	s2,32(sp)
    51bc:	ec4e                	sd	s3,24(sp)
    51be:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    51c0:	02051993          	slli	s3,a0,0x20
    51c4:	0209d993          	srli	s3,s3,0x20
    51c8:	09bd                	addi	s3,s3,15
    51ca:	0049d993          	srli	s3,s3,0x4
    51ce:	2985                	addiw	s3,s3,1
    51d0:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    51d2:	00004517          	auipc	a0,0x4
    51d6:	27e53503          	ld	a0,638(a0) # 9450 <freep>
    51da:	c905                	beqz	a0,520a <malloc+0x56>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    51dc:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    51de:	4798                	lw	a4,8(a5)
    51e0:	09377663          	bgeu	a4,s3,526c <malloc+0xb8>
    51e4:	f426                	sd	s1,40(sp)
    51e6:	e852                	sd	s4,16(sp)
    51e8:	e456                	sd	s5,8(sp)
    51ea:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    51ec:	8a4e                	mv	s4,s3
    51ee:	6705                	lui	a4,0x1
    51f0:	00e9f363          	bgeu	s3,a4,51f6 <malloc+0x42>
    51f4:	6a05                	lui	s4,0x1
    51f6:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    51fa:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    51fe:	00004497          	auipc	s1,0x4
    5202:	25248493          	addi	s1,s1,594 # 9450 <freep>
  if(p == (char*)-1)
    5206:	5afd                	li	s5,-1
    5208:	a83d                	j	5246 <malloc+0x92>
    520a:	f426                	sd	s1,40(sp)
    520c:	e852                	sd	s4,16(sp)
    520e:	e456                	sd	s5,8(sp)
    5210:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    5212:	0000b797          	auipc	a5,0xb
    5216:	a6678793          	addi	a5,a5,-1434 # fc78 <base>
    521a:	00004717          	auipc	a4,0x4
    521e:	22f73b23          	sd	a5,566(a4) # 9450 <freep>
    5222:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5224:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5228:	b7d1                	j	51ec <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    522a:	6398                	ld	a4,0(a5)
    522c:	e118                	sd	a4,0(a0)
    522e:	a899                	j	5284 <malloc+0xd0>
  hp->s.size = nu;
    5230:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5234:	0541                	addi	a0,a0,16
    5236:	ef9ff0ef          	jal	512e <free>
  return freep;
    523a:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    523c:	c125                	beqz	a0,529c <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    523e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5240:	4798                	lw	a4,8(a5)
    5242:	03277163          	bgeu	a4,s2,5264 <malloc+0xb0>
    if(p == freep)
    5246:	6098                	ld	a4,0(s1)
    5248:	853e                	mv	a0,a5
    524a:	fef71ae3          	bne	a4,a5,523e <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    524e:	8552                	mv	a0,s4
    5250:	b2bff0ef          	jal	4d7a <sbrk>
  if(p == (char*)-1)
    5254:	fd551ee3          	bne	a0,s5,5230 <malloc+0x7c>
        return 0;
    5258:	4501                	li	a0,0
    525a:	74a2                	ld	s1,40(sp)
    525c:	6a42                	ld	s4,16(sp)
    525e:	6aa2                	ld	s5,8(sp)
    5260:	6b02                	ld	s6,0(sp)
    5262:	a03d                	j	5290 <malloc+0xdc>
    5264:	74a2                	ld	s1,40(sp)
    5266:	6a42                	ld	s4,16(sp)
    5268:	6aa2                	ld	s5,8(sp)
    526a:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    526c:	fae90fe3          	beq	s2,a4,522a <malloc+0x76>
        p->s.size -= nunits;
    5270:	4137073b          	subw	a4,a4,s3
    5274:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5276:	02071693          	slli	a3,a4,0x20
    527a:	01c6d713          	srli	a4,a3,0x1c
    527e:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5280:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5284:	00004717          	auipc	a4,0x4
    5288:	1ca73623          	sd	a0,460(a4) # 9450 <freep>
      return (void*)(p + 1);
    528c:	01078513          	addi	a0,a5,16
  }
}
    5290:	70e2                	ld	ra,56(sp)
    5292:	7442                	ld	s0,48(sp)
    5294:	7902                	ld	s2,32(sp)
    5296:	69e2                	ld	s3,24(sp)
    5298:	6121                	addi	sp,sp,64
    529a:	8082                	ret
    529c:	74a2                	ld	s1,40(sp)
    529e:	6a42                	ld	s4,16(sp)
    52a0:	6aa2                	ld	s5,8(sp)
    52a2:	6b02                	ld	s6,0(sp)
    52a4:	b7f5                	j	5290 <malloc+0xdc>
